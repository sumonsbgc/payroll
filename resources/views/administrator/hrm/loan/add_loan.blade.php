                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group{{ $errors->has('loan_name') ? ' has-error' : '' }} has-feedback">
                                <input type="text" name="loan_name" id="loan_name" class="form-control"
                                    value="{{ old('loan_name') }}" placeholder="{{ __('Enter loan name..') }}">
                            ...
                            <label for="number_of_installments">{{ __('Number of Installment') }} <span
                            ...
                            <div
                                ...
                                <input type="text" name="number_of_installments" class="form-control pull-right"
                                    value="{{ old('number_of_installments') }}" id="number_of_installments"
                                    placeholder="{{ __('Enter number of installment') }}">
                            ...
                            <div class="form-group{{ $errors->has('loan_amount') ? ' has-error' : '' }} has-feedback">
                                <input type="text" name="loan_amount" id="loan_amount" class="form-control"
                                    value="{{ old('loan_amount') }}" placeholder="{{ __('Enter loan name..') }}">
                        ...
                        <div class="col-md-12">
                            ...
                            <div
                                ...
                                <textarea class="textarea text-description" name="loan_description"
                                    id="loan_description"
                                    placeholder="{{ __('Enter client description..') }}">{{ old('loan_description') }}</textarea>
