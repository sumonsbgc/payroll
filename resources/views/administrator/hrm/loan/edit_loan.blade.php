            ...
            <form action="{{ url('/hrm/loans/update/' . $loan['id']) }}" method="post" name="loan_add_form">
                ...
                <div class="box-body">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group{{ $errors->has('loan_name') ? ' has-error' : '' }} has-feedback">
                                <input type="text" name="loan_name" id="loan_name" class="form-control"
                                    value="{{ $loan['loan_name'] }}" placeholder="{{ __('Enter loan name..') }}">
                            ...
                            <div class="form-group{{ $errors->has('loan_amount') ? ' has-error' : '' }} has-feedback">
                                <input type="text" name="loan_amount" id="loan_amount" class="form-control"
                                    value="{{ $loan['loan_amount'] }}" placeholder="{{ __('Enter loan name..') }}">
                            ...
                            <label for="number_of_installments">{{ __('Number of Installments') }} <span
                                    class="text-danger">*</span></label>
                            <div
                                class="form-group{{ $errors->has('number_of_installments') ? ' has-error' : '' }} has-feedback">
                                <input type="text" name="number_of_installments" class="form-control pull-right"
                                    value="{{ $loan['number_of_installments'] }}" id="number_of_installments">
                            ...
                            <label for="remaining_installments">{{ __('Remaining Installments') }}<span
                                    class="text-danger">*</span></label>
                            <div
                                class="form-group{{ $errors->has('remaining_installments') ? ' has-error' : '' }} has-feedback">
                                <input type="text" name="remaining_installments" class="form-control pull-right"
                                    value="{{ $loan['remaining_installments'] }}" id="remaining_installments">
                        ...
                        <!-- /.col -->
                        <div class="col-md-12">
                            <label for="loan_description">{{ __('Loan Description') }} <span
                                    class="text-danger">*</span></label>
                            <div
                                class="form-group{{ $errors->has('loan_description') ? ' has-error' : '' }} has-feedback">
                                <textarea class="textarea text-description" name="loan_description"
                                    id="loan_description"
                                    placeholder="{{ __('Enter client description..') }}">{{ $loan['loan_description'] }}</textarea>
                ...
                <div class="box-footer">
                    <a href="{{ url('/hrm/loans') }}" class="btn btn-danger btn-flat"><i class="icon fa fa-close"></i>
                        {{ __('Cancel') }}</a>
                    <button type="submit" class="btn btn-primary btn-flat"><i class="icon fa fa-edit"></i>
                        {{ __('Update loan') }}</button>
                </div>
            </form>
        </div>
        <!-- /.box -->
