    ...
    <section class="content">
        ...
        <div class="box bt-none">
            ...
            <div class="box-body">
                ...
                <div class="col-md-6"> <a href="{{ url('/hrm/bonuses') }}" class="btn btn-primary btn-flat"><i
                            class="fa fa-arrow-left"></i> {{ __(' Back') }}</a></div>
                        ...
                        <tr>
                            <td colspan="2">
                                <div class="btn-group btn-group-justified">
                                    ...
                                    <div class="btn-group">
                                        <a href="{{ url('/hrm/bonuses/edit/' . $bonus['id']) }}"
                                    ...
                                    <div class="btn-group">
                                        <a href="{{ url('/hrm/bonuses/delete/' . $bonus['id']) }}"
