            ...
            <form action="{{ url('/hrm/bonuses/store') }}" method="post" name="bonus_add_form">
                ...
                <div class="box-body">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group{{ $errors->has('bonus_name') ? ' has-error' : '' }} has-feedback">
                                <input type="text" name="bonus_name" id="bonus_name" class="form-control"
                                    value="{{ old('bonus_name') }}" placeholder="{{ __('Enter bonus name..') }}">
                            ...
                            <div class="form-group{{ $errors->has('bonus_month') ? ' has-error' : '' }} has-feedback">
                                <div class="input-group date">
                                    ...
                                    <input type="text" name="bonus_month" class="form-control pull-right"
                                        value="{{ old('bonus_month')}}" id="monthpicker"
                                        placeholder="{{ __('yyy-mm-dd') }}">
                                </div>
                            ...
                            <label for="bonus_amount">{{ __('Bonus Amount') }} <span
                            ...
                            <div class="form-group{{ $errors->has('bonus_amount') ? ' has-error' : '' }} has-feedback">
                                <input type="text" name="bonus_amount" id="bonus_amount" class="form-control"
                                    value="{{ old('bonus_amount') }}" placeholder="{{ __('Enter bonus name..') }}">
                        ...
                        <!-- /.col -->
                        <div class="col-md-12">
                            <label for="bonus_description">{{ __('Bonus Description') }} <span
                                    class="text-danger">*</span></label>
                            <div
                                class="form-group{{ $errors->has('bonus_description') ? ' has-error' : '' }} has-feedback">
                                <textarea class="textarea text-description" name="bonus_description"
                                    id="bonus_description"
                                    placeholder="{{ __('Enter client description..') }}">{{ old('bonus_description') }}</textarea>
                ...
                <div class="box-footer">
                    <a href="{{ url('/hrm/bonuses') }}" class="btn btn-danger btn-flat"><i
