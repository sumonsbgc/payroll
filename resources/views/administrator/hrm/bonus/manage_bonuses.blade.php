    ...
    <section class="content">
        ...
        <div class="box bt-none">
            ...
            <div class="box-body">
                ...
                <div class="col-md-6"> <a href="{{ url('/hrm/bonuses/create') }}" class="btn btn-primary btn-flat"><i
                            class="fa fa-plus"></i> {{ __(' Add bonus') }}</a></div>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <a href="{{ url('/hrm/bonuses/edit/' . $bonus['id']) }}"><i
