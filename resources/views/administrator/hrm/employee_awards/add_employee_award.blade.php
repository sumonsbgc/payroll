      ...
      <form action="{{ url('/hrm/employee-awards/store') }}" method="post" name="employee_award_add_form">
        ...
        <div class="box-body">
          <div class="row">
            ...
            <div class="col-md-6">
              ...
              <div class="form-group{{ $errors->has('gift_item') ? ' has-error' : '' }} has-feedback">
                <input type="text" name="gift_item" id="gift_item" class="form-control" value="{{ old('gift_item') }}"
                  placeholder="{{ __('Enter Gift Item..') }}">
              ...
              <div class="form-group{{ $errors->has('description') ? ' has-error' : '' }} has-feedback">
                <textarea class="textarea text-description" name="description" id="description"
                  placeholder="{{ __('Enter employee award description..') }}">{{ old('description') }}</textarea>
          ...
          <div class="box-footer">
            <a href="{{ url('/hrm/employee-awards') }}" class="btn btn-danger btn-flat"><i
