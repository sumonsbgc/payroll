...
<div class="content-wrapper">
  ...
  <section class="content">
    ...
    <div class="box box-default bt-none">
      ...
      <!-- /.box-header -->
      <form action="{{ url('/hrm/employee-awards/update/' . $employee_award['id']) }}" method="post"
        ...
        <div class="box-body">
            ...
            <div class="col-md-6">
              ...
              <div class="form-group{{ $errors->has('gift_item') ? ' has-error' : '' }} has-feedback">
                <input type="text" name="gift_item" id="gift_item" class="form-control"
                  value="{{ $employee_award['gift_item'] }}" placeholder="{{ __('Enter Gift Item..') }}">
              ...
              <div class="form-group">
                ...
                <div class="input-group date">
                  ...
                  <input type="text" name="select_month" value="{{ $employee_award['select_month'] }}"
              ...
              <div class="form-group{{ $errors->has('description') ? ' has-error' : '' }} has-feedback">
                <textarea class="textarea text-description" name="description" id="description"
                  placeholder="{{ __('Enter employee award description..') }}">{{$employee_award['description']}}</textarea>
          ...
          <div class="box-footer">
            <a href="{{ url('/hrm/employee-awards') }}" class="btn btn-danger btn-flat"><i class="icon fa fa-close"></i>
              {{ __('Cancel') }}</a>
            <button type="submit" class="btn btn-primary btn-flat"><i class="icon fa fa-plus"></i>
              {{ __('Add Employee Award') }}</button>
          </div>
      </form>
    </div>
    <!-- /.box -->
