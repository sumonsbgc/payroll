...
<div class="content-wrapper">
    ...
    <section class="content">
        ...
        <div class="box bt-none">
            ...
            <div class="box-body">
                <div class="col-md-6">
                    <a href="{{ url('/hrm/employee-awards/create') }}" class="btn btn-primary btn-flat"><i
                            class="fa fa-plus"></i>{{ __(' Add employee award') }}</a>
                </div>
                    ...
                    <table class="table table-bordered table-striped">
                        ...
                        <tbody id="myTable">
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <a href="{{ url('/hrm/employee-awards/edit/' . $employee_aword['id']) }}"><i
