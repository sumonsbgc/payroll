        ...
        <div class="box bt-none">
            ...
            <div class="box-body">
                <div class="text-right">
                    <a href="{{ url('/hrm/attendance/details/report/go') }}"
                        class="btn bg-green px-5 py-1 text-uppercase">
                        <i class="fa fa-plus"></i>
                        {{ __('add new Attendance Statement') }}
                    </a>

                    <form action="{{ url('/hrm/attendance/details/report/pdf') }}" method="get" class="d-inline-block">
                        {{ csrf_field() }}
                        ...
                        <button type="submit" class="btn bg-blue px-5 py-1">{{ __('PDF') }} </button>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <b class="btn bg-blue">{{ __('No Leave') }}</b>
                                    @else
