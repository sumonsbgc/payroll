                    ...
                    <table class="table table-bordered table-striped">
                        <thead>
                            <tr>
                                ...
                                <th>{{ __('In Time /') }} <a href="#" data-toggle="modal"
                                        data-target="#modal-sm">{{ __('Set Time') }}</a></th>
                                <th>{{ __('Out Time /') }} <a href="#" data-toggle="modal"
                                        data-target="#modal-sm">{{ __('Set Time') }}</a></th>
                            </tr>
                        </thead>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a
                                        href="{{ url('/hrm/attendance/details/' . $employee['id']) }}">{{ $employee['name'] }}</a>
                                    ...
                                    <div class="form-group">
                                        <select name="leave_category_id[]" class="form-control">
                                            ...
                                            <option value="{{ $leave_category['id'] }}">
                                                {{ $leave_category['leave_category'] }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </td>
                        ...
                        <tfoot>
                            <tr>
                                <td colspan="7"><button type="submit" class="btn btn-primary btn-flat pull-right"><i
                                            class="icon fa fa-save"></i> {{ __('Save') }}</button></td>
                            </tr>
                        </tfoot>
                    </table>
                </form>
