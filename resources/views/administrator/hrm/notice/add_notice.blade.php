    ...
    <div class="box box-default bt-none">
      ...
      <form action="{{ url('hrm/notice/store') }}" method="post" name="notice_add_form">
            ...
            <div class="col-md-6">
              ...
              <div class="form-group{{ $errors->has('notice_title') ? ' has-error' : '' }} has-feedback">
                <input type="text" name="notice_title" id="notice_title" class="form-control"
                  value="{{ old('notice_title') }}" placeholder="{{ __('Enter notice title..') }}">
            ...
            <div class="col-md-12">
              ...
              <div class="form-group{{ $errors->has('description') ? ' has-error' : '' }} has-feedback">
                <textarea class="textarea text-description" name="description" id="description"
                  placeholder="{{ __('Enter Notice description..') }}">{{ old('description') }}</textarea>
        ...
        <div class="box-footer">
          <a href="{{ url('/hrm/notice') }}" class="btn btn-danger btn-flat"><i class="icon fa fa-close"></i>
            {{ __('Cancel') }}</a>
