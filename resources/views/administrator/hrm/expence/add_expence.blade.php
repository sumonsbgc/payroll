            ...
            document.getElementById('theDate1').value = today;
              ...
              <div class="form-group{{ $errors->has('balance_amount') ? ' has-error' : '' }} has-feedback">
                <input type="text" name="exp_amount" id="balance_amount" class="form-control"
                  value="{{ old('balance_amount') }}" placeholder="{{ __('Enter Balance amount..') }}">
              ...
              <div class="form-group">
                <input type="text" name="cheque_no" class="form-control" value="{{ old('balance_amount') }}"
                  placeholder="{{ __('Enter Cheque No.') }}">
              </div>
            ...
            <div class="col-md-12">
              ...
              <div class="form-group{{ $errors->has('remarks_if_any') ? ' has-error' : '' }} has-feedback">
                <textarea class="textarea text-description" name="particular"
                  placeholder="{{ __('Enter Purchased Details..') }}">{{ old('remarks_if_any') }}</textarea>
