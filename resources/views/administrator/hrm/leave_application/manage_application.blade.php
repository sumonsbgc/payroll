...
<div class="content-wrapper">
    ...
    <section class="content">
        ...
        <div class="box bt-none">
            ...
            <div class="box-body">
                <div class="col-md-6">
                    <a href="{{ url('/hrm/leave_application/create') }}" class="btn btn-primary btn-flat"><i
                            class="fa fa-plus"></i> {{ __('Add leave application') }}</a>
                </div>
                <div class="col-md-6">
                    ...
                    <table class="table table-bordered table-striped">
                        ...
                        <tbody id="myTable">
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    ...
                                    <a href="" class="btn btn-warning btn-xs btn-flat btn-block" data-toggle="tooltip"
                                        data-original-title="Pending"><i
                                            class="icon fa fa-hourglass-2"></i>{{ __('Pending') }} </a>
                                ...
                                <td class="text-center">
                                    <a href="{{ url('/hrm/leave_application/' .$leave_application['id']) }}"><i
                                            class="icon fa fa-file-text"></i> {{ __('Details') }}</a>
                                </td>
                            </tr>
                            @endforeach
