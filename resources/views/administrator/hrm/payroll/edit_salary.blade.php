  ...
  <section class="content">
    <div class="row">
      <div class="col-md-12">
        ...
        <div class="box box-primary bt-none">
          ...
          <div class="box-body">
            ...
            <!-- /.Notification Box -->
            <div class="col-md-12">
              <form class="form-horizontal" name="employee_select_form" action="{{ url('/hrm/payroll/go') }}"
                method="post">
                {{ csrf_field() }}
      ...
      <form name="employee_salary_form" id="employee_salary_form"
        action="{{ url('/hrm/payroll/update/' . $salary['id']) }}" method="post">
        {{ csrf_field() }}
                ...
                <div class="form-group{{ $errors->has('basic_salary') ? ' has-error' : '' }}">
                  ...
                  <div class="col-sm-6">
                    <input type="number" name="basic_salary" class="form-control" id="basic_salary"
                      value="{{ $salary['basic_salary'] }}" placeholder="{{ __('Enter basic salary..') }}">
