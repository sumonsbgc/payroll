...
<div class="content-wrapper">
	...
	<section class="content">
		...
		<div class="box box-default bt-none">
			...
			<!-- /.box-header -->
			<form action="{{ url('/setting/holidays/update/' . $holidays['id']) }}" method="post"
					...
					<div class="row">
						...
						<div class="col-md-6">
							...
							<div class="form-group{{ $errors->has('holiday_name') ? ' has-error' : '' }} has-feedback">
								<input type="text" name="holiday_name" value="{{ $holidays['holiday_name'] }}"
						...
						<div class="col-md-12">
							...
							<div class="form-group{{ $errors->has('description') ? ' has-error' : '' }} has-feedback">
								<textarea class="textarea text-description" name="description"
									id="description">{{ $holidays['description'] }}</textarea>
