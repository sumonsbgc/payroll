...
<div class="content-wrapper">
  ...
  <section class="content">
    ...
    <div class="box bt-none">
      ...
      <div class="box-body">
        <a href="{{ url('/setting/holidays') }}" class="btn btn-primary btn-flat"><i class="fa fa-arrow-left"></i>
          {{ __('Back') }}</a>
        <hr>
            ...
            <tr>
              <td colspan="2">
                <div class="btn-group btn-group-justified">
                  ...
                  <div class="btn-group">
                    <a href="{{ url('/setting/holidays/unpublished/' . $holidays['id'])}}"
                  ...
                  @else
                  <div class="btn-group">
                    <a href="{{ url('/setting/holidays/published/' . $holidays['id'])}}"
                  ...
                  <div class="btn-group">
                    <a href="{{ url('/setting/holidays/edit/' . $holidays['id']) }}"
                  ...
                  <div class="btn-group">
                    <a href="{{ url('/setting/holidays/delete/' . $holidays['id']) }}"
                      onclick="return confirm('Are you sure to delete this ?');" class="tip btn btn-danger bpo btn-flat"
                      title=""
                      data-content="<div><p>{{ __('Are you sure?') }}</p><a class='btn btn-danger' href='https://btrc.gunitok.com/products/delete/1'>{{ __('Yes I am sure') }}</a> <button class='btn bpo-close'>{{ __('No') }}</button></div>"
                      data-html="true" data-placement="top" data-original-title="<b>{{ __('Delete Product') }}</b>">
