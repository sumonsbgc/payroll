...
<div class="content-wrapper">
    ...
    <section class="content">
        ...
        <div class="box box-default bt-none">
            ...
            <!-- /.box-header -->
            <form action="{{ url('/setting/departments/update/'. $department['id']) }}" method="post"
                ...
                <div class="box-body">
                    <div class="row">
                        ...
                        <!-- /.col -->
                        <div class="col-md-12">
                            <label for="department_description">{{ __('Department Description') }} <span
                                    class="text-danger">*</span></label>
                            <div
                                class="form-group{{ $errors->has('department_description') ? ' has-error' : '' }} has-feedback">
                                <textarea class="textarea text-description" name="department_description"
                                    id="department_description"
                                    placeholder="{{ __('Enter client description..') }}">{{ $department['department_description'] }}</textarea>
                                @if ($errors->has('department'))
                                <span class="help-block">
