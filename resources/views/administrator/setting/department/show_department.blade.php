...
<div class="content-wrapper">
    ...
    <section class="content">
        ...
        <div class="box bt-none">
            ...
            <div class="box-body">
                <a href="{{ url('/setting/departments') }}" class="btn btn-primary btn-flat"><i
                ...
                <table class="table table-bordered table-striped">
                    <tbody id="myTable">
                        ...
                        <tr>
                            ...
                            <div class="btn-group">
                                <a href="{{ url('/setting/departments/unpublished/' . $department->id)}}"
                            ...
                            @else
                            <div class="btn-group">
                                <a href="{{ url('/setting/departments/published/' . $department->id)}}"
