                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group{{ $errors->has('department') ? ' has-error' : '' }} has-feedback">
                                <input type="text" name="department" id="department" class="form-control"
                                    value="{{ old('department') }}" placeholder="{{ __('Enter client name..') }}">
                        ...
                        <div class="col-md-12">
                            ...
                            <div
                                ...
                                <textarea class="textarea text-description" name="department_description"
                                    ...
                                    placeholder="{{ __('Enter client description..') }}">{{ old('department_description') }}</textarea>
                                @if ($errors->has('department'))
                                <span class="help-block">
