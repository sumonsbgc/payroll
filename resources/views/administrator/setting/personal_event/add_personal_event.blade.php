                ...
                <div class="box-body">
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            @else
                            <p class="text-yellow">{{ __('Enter personal_event details. All field are required.') }}
                            </p>
                            @endif
                        </div>
                        <!-- /.Notification Box -->
                        ...
                        <div class="col-md-6">
                            ...
                            <div
                                ...
                                <input type="text" name="personal_event" id="personal_event" class="form-control"
                                    value="{{ old('personal_event') }}" placeholder="{{ __('Enter client name..') }}">
                        ...
                        <div class="col-md-12">
                            ...
                            <div
                                ...
                                <textarea class="textarea text-description" name="personal_event_description"
                                    ...
                                    placeholder="{{ __('Enter client description..') }}">{{ old('personal_event_description') }}</textarea>
                                @if ($errors->has('personal_event'))
                                <span class="help-block">
