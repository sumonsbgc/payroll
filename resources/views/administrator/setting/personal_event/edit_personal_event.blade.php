...
<div class="content-wrapper">
    ...
    <section class="content">
        ...
        <div class="box box-default bt-none">
            ...
            <!-- /.box-header -->
            <form action="{{ url('/setting/personal-events/update/'. $personal_event['id']) }}" method="post"
                ...
                <div class="box-body">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <label for="personal_event">{{ __('Personal Event') }} <span
                                    class="text-danger">*</span></label>
                            <div
                                class="form-group{{ $errors->has('personal_event') ? ' has-error' : '' }} has-feedback">
                                <input type="text" name="personal_event" id="personal_event" class="form-control"
                                    value="{{ $personal_event['personal_event'] }}">
                            ...
                            <div class="form-group{{ $errors->has('start_date') ? ' has-error' : '' }} has-feedback">
                                <input type="text" name="start_date" id="datepicker" class="form-control"
                                    value="{{ $personal_event['start_date'] }}">
                            ...
                            <!-- /.form-group -->
                            <label for="publication_status">{{ __('Publication Status ') }}<span
                                    class="text-danger">*</span></label>
                            <div
                                class="form-group{{ $errors->has('publication_status') ? ' has-error' : '' }} has-feedback">
                        ...
                        <!-- /.col -->
                        <div class="col-md-12">
                            <label for="personal_event_description">{{ __('Personal Event Description') }} <span
                                    class="text-danger">*</span></label>
                            <div
                                class="form-group{{ $errors->has('personal_event_description') ? ' has-error' : '' }} has-feedback">
                                <textarea class="textarea text-description" name="personal_event_description"
                                    id="personal_event_description">{{ $personal_event['personal_event_description'] }}</textarea>
                                @if ($errors->has('personal_event'))
                                <span class="help-block">
