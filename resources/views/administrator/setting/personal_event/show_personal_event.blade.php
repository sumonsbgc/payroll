...
<div class="content-wrapper">
    ...
    <section class="content">
        ...
        <div class="box bt-none">
            ...
            <div class="box-body">
                <a href="{{ url('/setting/personal-events') }}" class="btn btn-primary btn-flat"><i
                        ...
                        <tr>
                            <td colspan="2">
                                <div class="btn-group btn-group-justified">
                                    ...
                                    <div class="btn-group">
                                        <a href="{{ url('/setting/personal-events/unpublished/' . $personal_event['id'])}}"
                                    ...
                                    @else
                                    <div class="btn-group">
                                        <a href="{{ url('/setting/personal-events/published/' . $personal_event['id'])}}"
                                    ...
                                    <div class="btn-group">
                                        <a href="{{ url('/setting/personal-events/edit/' . $personal_event['id']) }}"
                                    ...
                                    <div class="btn-group">
                                        <a href="{{ url('/setting/personal-events/delete/' . $personal_event['id']) }}"
                                            ...
                                            data-original-title="<b>{{ __('Delete Product') }}</b>">
