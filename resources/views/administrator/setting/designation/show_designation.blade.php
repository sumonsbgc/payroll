...
<div class="content-wrapper">
    ...
    <section class="content">
        ...
        <div class="box bt-none">
            ...
            <div class="box-body">
                <a href="{{ url('/setting/designations') }}" class="btn btn-primary btn-flat"><i
                    ...
                    <tbody id="myTable">
                        ...
                        <tr>
                            ...
                            <div class="btn-group btn-group-justified">
                                ...
                                <div class="btn-group">
                                    <a href="{{ url('/setting/designations/unpublished/' . $designation['id'])}}"
                                ...
                                @else
                                <div class="btn-group">
                                    <a href="{{ url('/setting/designations/published/' . $designation['id'])}}"
                                ...
                                <div class="btn-group">
                                    <a href="{{ url('/setting/designations/edit/' . $designation['id']) }}"
