...
<div class="content-wrapper">
    ...
    <section class="content">
        ...
        <div class="box box-default bt-none">
            ...
            <!-- /.box-header -->
            <form action="{{ url('/setting/designations/update/'. $designation['id']) }}" method="post"
                ...
                <div class="box-body">
                    <div class="row">
                        ...
                        <!-- /.col -->
                        <div class="col-md-12">
                            <label for="designation_description">{{ __('Designation Description') }} <span
                                    class="text-danger">*</span></label>
                            <div
                                class="form-group{{ $errors->has('designation_description') ? ' has-error' : '' }} has-feedback">
                                <textarea class="textarea text-description" name="designation_description"
                                    id="designation_description">{{ $designation['designation_description'] }}</textarea>
                                @if ($errors->has('designation'))
                                <span class="help-block">
