    ...
    <section class="content">
        ...
        <div class="box bt-none">
            ...
            <div class="box-body">
                ...
                <div class="col-md-6">
                    <a href="{{ url('/setting/leave_categories/create') }}" class="btn btn-primary btn-flat"><i
                            class="fa fa-plus"></i> {{ __('Add leave category') }}</a>
                </div>
                <div class="col-md-6">
                    ...
                    <table class="table table-bordered table-striped">
                        ...
                        <tbody id="myTable">
                            ...
                            <tr>
                                ...
                                <td class="text-center">{{ date("d F Y", strtotime($leave_category['created_at'])) }}
                                </td>
                                ...
                                <td class="text-center">
                                    <a href="{{ url('/setting/leave_categories/edit/' . $leave_category['id']) }}"><i
