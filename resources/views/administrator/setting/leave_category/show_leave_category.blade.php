...
<div class="content-wrapper">
    ...
    <section class="content">
        ...
        <div class="box bt-none">
            ...
            <div class="box-body">
                <a href="{{ url('/setting/leave_categories') }}" class="btn btn-primary btn-flat"><i
                        ...
                        <tr>
                            <td colspan="2">
                                <div class="btn-group btn-group-justified">
                                    ...
                                    <div class="btn-group">
                                        <a href="{{ url('/setting/leave_categories/unpublished/' . $leave_category['id'])}}"
                                    ...
                                    @else
                                    <div class="btn-group">
                                        <a href="{{ url('/setting/leave_categories/published/' . $leave_category['id'])}}"
                                    ...
                                    <div class="btn-group">
                                        <a href="{{ url('/setting/leave_categories/edit/' . $leave_category['id']) }}"
                                    ...
                                    <div class="btn-group">
                                        <a href="{{ url('/setting/leave_categories/delete/' . $leave_category['id']) }}"
