...
<div class="content-wrapper">
    ...
    <section class="content">
        ...
        <div class="box box-default bt-none">
            ...
            <!-- /.box-header -->
            <form action="{{ url('/setting/leave_categories/update/'. $leave_category['id']) }}" method="post"
                        ...
                        <div class="col-md-6">
                            ...
                            <div
                                ...
                                <input type="text" name="leave_category" id="leave_category" class="form-control"
                                    value="{{ $leave_category['leave_category'] }}">
                        ...
                        <div class="col-md-12">
                            ...
                            <div
                                ...
                                <textarea class="textarea text-description" name="leave_category_description"
                                    id="leave_category_description">{{ $leave_category['leave_category_description'] }}</textarea>
                                @if ($errors->has('leave_category'))
                                <span class="help-block">
                ...
                <div class="box-footer">
                    ...
                    <button type="submit" class="btn btn-primary btn-flat"><i class="icon fa fa-edit"></i>
                        {{ __('Update leave category') }}</button>
                </div>
            </form>
        </div>
        <!-- /.box -->
