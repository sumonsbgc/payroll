...
<div class="content-wrapper">
    ...
    <section class="content">
        ...
        <div class="box box-default bt-none">
            ...
            <!-- /.box-header -->
            <form action="{{ url('/setting/job-types/update/'. $job_type['id']) }}" method="post"
                ...
                <div class="box-body">
                    <div class="row">
                        ...
                        <!-- /.col -->
                        <div class="col-md-12">
                            <label for="job_type_description">{{ __('Job Type Description ') }}<span
                                    class="text-danger">*</span></label>
                            <div
                                class="form-group{{ $errors->has('job_type_description') ? ' has-error' : '' }} has-feedback">
                                <textarea class="textarea text-description" name="job_type_description"
                                    id="job_type_description">{{ $job_type['job_type_description'] }}</textarea>
                                @if ($errors->has('job_type'))
                                <span class="help-block">
                ...
                <div class="box-footer">
                    <a href="{{ url('/setting/job-types') }}" class="btn btn-danger btn-flat"><i
                            class="icon fa fa-close"></i>{{ __('Cancel') }} </a>
                    <button type="submit" class="btn btn-primary btn-flat"><i
                            class="icon fa fa-edit"></i>{{ __('Update job type') }} </button>
                </div>
            </form>
        </div>
        <!-- /.box -->
