    ...
    <section class="content">
        ...
        <div class="box bt-none">
            ...
            <div class="box-body">
                ...
                <div class="col-md-6">
                    <a href="{{ url('/setting/job-types/create') }}" class="btn btn-primary btn-flat"><i
                            class="fa fa-plus"></i> {{ __('Add job type') }}</a>
                </div>
                <div class="col-md-6">
                ...
                <table class="table table-bordered table-striped">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="{{ url('/setting/job-types/edit/' . $job_type['id']) }}"><i
