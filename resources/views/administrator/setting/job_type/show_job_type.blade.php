...
<div class="content-wrapper">
    ...
    <section class="content">
        ...
        <div class="box bt-none">
            ...
            <div class="box-body">
                <a href="{{ url('/setting/job-types') }}" class="btn btn-primary btn-flat"><i
                        ...
                        <tr>
                            <td colspan="2">
                                <div class="btn-group btn-group-justified">
                                    ...
                                    <div class="btn-group">
                                        <a href="{{ url('/setting/job-types/unpublished/' . $job_type->id)}}"
                                    ...
                                    @else
                                    <div class="btn-group">
                                        <a href="{{ url('/setting/job-types/published/' . $job_type->id)}}"
                                    ...
                                    <div class="btn-group">
                                        <a href="{{ url('/setting/job-types/edit/' . $job_type->id) }}"
                                    ...
                                    <div class="btn-group">
                                        <a href="{{ url('/setting/job-types/delete/' . $job_type->id) }}"
