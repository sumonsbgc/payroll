    ...
    <section class="content">
        ...
        <div class="box bt-none">
            ...
            <div class="box-body">
                ...
                <div class="col-md-6">
                    <a href="{{ url('/setting/award_categories/create') }}" class="btn btn-primary btn-flat"><i
                            class="fa fa-plus"></i>{{ __('Add Award Category Lists') }} </a>
                </div>
                <div class="col-md-6">
                    ...
                    <table class="table table-bordered table-striped">
                        ...
                        <tbody id="myTable">
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <a href="{{ url('/setting/award_categories/edit/' . $award_category['id']) }}"><i
