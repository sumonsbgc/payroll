...
<div class="content-wrapper">
  ...
  <section class="content">
    ...
    <div class="box box-default bt-none">
      ...
      <!-- /.box-header -->
      <form action="{{ url('/setting/award_categories/update/' . $award_categorys['id']) }}" method="post"
            ...
            <div class="col-md-6">
              ...
              <div class="form-group{{ $errors->has('award_title') ? ' has-error' : '' }} has-feedback">
                <input type="text" name="award_title" id="award_title" class="form-control"
                  value="{{ $award_categorys['award_title'] }}">
        ...
        <div class="box-footer">
          <a href="{{ url('/setting/award_categories') }}" class="btn btn-danger btn-flat"><i
