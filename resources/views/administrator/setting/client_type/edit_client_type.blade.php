...
<div class="content-wrapper">
    ...
    <section class="content">
        ...
        <div class="box box-default bt-none">
            ...
            <!-- /.box-header -->
            <form action="{{ url('/setting/client-types/update/'. $client_type['id']) }}" method="post"
                ...
                <div class="box-body">
                    <div class="row">
                        ...
                        <!-- /.col -->
                        <div class="col-md-12">
                            <label for="client_type_description">{{ __('Client Type Description') }} <span
                                    class="text-danger">*</span></label>
                            <div
                                class="form-group{{ $errors->has('client_type_description') ? ' has-error' : '' }} has-feedback">
                                <textarea class="textarea text-description" name="client_type_description"
                                    id="client_type_description"
                                    placeholder="{{ __('Enter client description..') }}">{{ $client_type['client_type_description'] }}</textarea>
                                @if ($errors->has('client_type'))
                                <span class="help-block">
