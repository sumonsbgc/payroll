...
<div class="content-wrapper">
    ...
    <section class="content">
        ...
        <div class="box bt-none">
            ...
            <div class="box-body">
                <div class="col-md-6"> <a href="{{ url('/setting/client-types/create') }}"
                        class="btn btn-primary btn-flat"><i class="fa fa-plus"></i> {{ __('Add client type') }}</a>
                </div>
                    ...
                    <table class="table table-bordered table-striped">
                        ...
                        <tbody id="myTable">
                            ...
                            <tr>
                                <td>{{ $sl++ }}</td>
                                <td><a
                                        href="{{ url('/setting/client-types/details/' . $client_type['id']) }}">{{ $client_type['client_type'] }}</a>
                                </td>
                                ...
                                <td class="text-center">
                                    <a href="{{ url('/setting/client-types/edit/' . $client_type['id']) }}"><i
