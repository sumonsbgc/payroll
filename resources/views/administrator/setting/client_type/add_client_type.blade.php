                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group{{ $errors->has('client_type') ? ' has-error' : '' }} has-feedback">
                                <input type="text" name="client_type" id="client_type" class="form-control"
                                    value="{{ old('client_type') }}" placeholder="{{ __('Enter client name..') }}">
                        ...
                        <div class="col-md-12">
                            ...
                            <div
                                ...
                                <textarea class="textarea text-description" name="client_type_description"
                                    ...
                                    placeholder="{{ __('Enter client description..') }}">{{ old('client_type_description') }}</textarea>
                                @if ($errors->has('client_type'))
                                <span class="help-block">
