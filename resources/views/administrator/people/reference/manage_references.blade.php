    ...
    <section class="content">
        ...
        <div class="box bt-none">
            ...
            <div class="box-body">
                ...
                <div class="col-md-3">
                    <a href="{{ url('/people/references/create') }}" class="btn btn-primary btn-flat"><i
                            class="fa fa-plus"></i> {{ __('Add reference') }}</a>
                </div>
                <div class="col-md-6">
                        ...
                        <tbody id="myTable">
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <a href="{{ url('/people/references/edit/' . $reference['id']) }}"><i
