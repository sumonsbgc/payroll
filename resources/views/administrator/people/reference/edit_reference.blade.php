...
<div class="content-wrapper">
    ...
    <section class="content">
        ...
        <div class="box box-default bt-none">
            ...
            <!-- /.box-header -->
            <form action="{{ url('people/references/update/'.$reference['id']) }}" method="post"
                ...
                <div class="box-body">
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            @else
                            <p class="text-yellow">{{ __('Enter reference type details. All field are required.') }}
                            </p>
                            @endif
                        </div>
                        <!-- /.Notification Box -->
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }} has-feedback">
                                <input type="text" name="name" id="name" class="form-control"
                                    value="{{ $reference['name'] }}" placeholder="{{ __('Enter name..') }}">
                                @if ($errors->has('name'))
                            ...
                            <div class="form-group{{ $errors->has('email') ? ' has-error' : '' }} has-feedback">
                                <input type="text" name="email" id="email" class="form-control"
                                    value="{{ $reference['email'] }}" placeholder="{{ __('Enter email address..') }}">
                                @if ($errors->has('email'))
                                <span class="help-block">
                            ...
                            <div
                                ...
                                <input type="text" name="contact_no_one" id="contact_no_one" class="form-control"
                                    value="{{ $reference['contact_no_one'] }}"
                            ...
                            <div class="form-group{{ $errors->has('web') ? ' has-error' : '' }} has-feedback">
                                <input type="text" name="web" id="web" class="form-control"
                                    value="{{ $reference['web'] }}" placeholder="{{ __('Enter web..') }}">
                                @if ($errors->has('web'))
                                <span class="help-block">
                            ...
                            <div class="form-group{{ $errors->has('date_of_birth') ? ' has-error' : '' }} has-feedback">
                                <div class="input-group date">
                                    ...
                                    <input type="text" name="date_of_birth" class="form-control pull-right"
                                        value="{{ $reference['date_of_birth'] }}" id="datepicker">
                                </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <div
                                ...
                                <input type="text" name="present_address" id="present_address" class="form-control"
                                    value="{{ $reference['present_address'] }}"
                            ...
                            <div
                                ...
                                <input type="text" name="contact_no_two" id="contact_no_two" class="form-control"
                                    value="{{ $reference['contact_no_two'] }}"
                                    placeholder="{{ __('Enter address..') }}">
