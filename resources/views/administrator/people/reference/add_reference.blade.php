...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            <li><a href="{{ url('/dashboard') }}"><i class="fa fa-dashboard"></i> {{ __('Dashboard') }}Dashboard</a>
            </li>
            ...
            <form action="{{ url('people/references/store') }}" method="post" name="reference_add_form">
                        ...
                        <div class="col-md-6">
                            ...
                            <div
                                ...
                                <input type="text" name="contact_no_one" id="contact_no_one" class="form-control"
                                    value="{{ old('contact_no_one') }}" placeholder="{{ __('Enter contact no..') }}">
                        ...
                        <div class="col-md-6">
                            ...
                            <div
                                ...
                                <input type="text" name="present_address" id="present_address" class="form-control"
                                    value="{{ old('present_address') }}" placeholder="{{ __('Enter address..') }}">
                            ...
                            <div
                                ...
                                <input type="text" name="contact_no_two" id="contact_no_two" class="form-control"
                                    value="{{ old('contact_no_two') }}" placeholder="{{ __('Enter address..') }}">
                ...
                <div class="box-footer">
                    ...
                    <button type="submit" class="btn btn-primary btn-flat"><i
                            class="icon fa fa-plus"></i>{{ __(' Add reference') }}</button>
                </div>
            </form>
        </div>
        <!-- /.box -->
