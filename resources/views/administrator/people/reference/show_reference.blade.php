...
<div class="content-wrapper">
    ...
    <section class="content">
        ...
        <div class="box bt-none">
            ...
            <div class="box-body">
                <a href="{{ url('/people/references') }}" class="btn btn-primary btn-flat"><i
                ...
                <div class="btn-group btn-group-justified">
                    ...
                    <div class="btn-group">
                        <a href="{{ url('/people/references/deactive/' . $reference->id)}}"
                    ...
                    @else
                    <div class="btn-group">
                        <a href="{{ url('/people/references/active/' . $reference->id)}}"
                    ...
                    <div class="btn-group">
                        <a href="{{ url('/people/references/download-pdf/' . $reference->id) }}"
                    ...
                    <div class="btn-group">
                        <a href="{{ url('/people/references/edit/' . $reference->id) }}"
                    ...
                    <div class="btn-group">
                        <a href="{{ url('/people/references/delete/' . $reference->id) }}"
