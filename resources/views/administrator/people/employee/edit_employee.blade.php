...
<div class="content-wrapper">
    ...
    <section class="content">
        ...
        <div class="box box-default bt-none">
            ...
            <!-- /.box-header -->
            <form action="{{ url('people/employees/update/'.$employee['id']) }}" method="post"
                ...
                <div class="box-body">
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            @else
                            <p class="text-yellow">
                                {{ __(' Enter team member details. All (*)field are required. (Default password for added user is 12345678)') }}
                            </p>
                            @endif
                        </div>
                        <!-- /.Notification Box -->
                        ...
                        <div class="col-md-6">
                            ...
                            <div
                                class="form-group{{ $errors->has('permanent_address') ? ' has-error' : '' }} has-feedback">
                            ...
                            <label for="joining_position">{{ __(' Department') }} <span
                                    class="text-danger">*</span></label>
                            <div
                                class="form-group{{ $errors->has('joining_position') ? ' has-error' : '' }} has-feedback">
                            ...
                            <div
                                class="form-group{{ $errors->has('marital_status') ? ' has-error' : '' }} has-feedback">
                            ...
                            <div class="form-group{{ $errors->has('date_of_birth') ? ' has-error' : '' }} has-feedback">
                                <div class="input-group date">
                                    ...
                                    <input type="text" name="date_of_birth" class="form-control pull-right"
                                        value="{{ $employee['date_of_birth'] }}" id="datepicker3">
                                </div>
                        ...
                        <div class="col-md-12">
                            ...
                            <div
                                ...
                                <textarea name="academic_qualification" id="academic_qualification"
                                    class="form-control textarea">{{ $employee['academic_qualification'] }}</textarea>
                            ...
                            <div
                                ...
                                <textarea name="professional_qualification" id="professional_qualification"
                                    class="form-control textarea">{{ $employee['professional_qualification'] }}</textarea>
                            ...
                            <div class="form-group{{ $errors->has('experience') ? ' has-error' : '' }} has-feedback">
                                <textarea name="experience" id="experience"
                                    class="form-control textarea">{{ $employee['experience'] }}</textarea>
                    ...
                    <div class="box-footer">
                        <a href="{{ url('/people/employees') }}" class="btn btn-danger btn-flat"><i
