        ...
        <div class="box bt-none">
            ...
            <div class="box-body">
                ...
                <div class="btn-group btn-group-justified">
                    ...
                    <div class="btn-group">
                        <a href="{{ url('/people/employees/deactive/' . $employee->id)}}"
                    ...
                    @else
                    <div class="btn-group">
                        <a href="{{ url('/people/employees/active/' . $employee->id)}}"
                    ...
                    <div class="btn-group">
                        <a href="{{ url('/people/employees/edit/' . $employee->id) }}"
                    ...
                    <div class="btn-group">
                        <a href="{{ url('/people/employees/delete/' . $employee->id) }}"
