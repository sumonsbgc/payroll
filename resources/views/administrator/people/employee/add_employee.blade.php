                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            ...
                            <div class="form-group{{ $errors->has('fingerprint_user_id') ? ' has-error' : '' }} has-feedback">
                                <input type="text" name="fingerprint_user_id" id="fingerprint_user_id" class="form-control" value="{{ old('fingerprint_user_id') }}" placeholder="{{ __('Enter Fingerprint Registration ID..') }}">
