                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }} has-feedback">
                                <input type="text" name="name" id="name" class="form-control"
                                    value="{{ $client['name'] }}" placeholder="{{ __('Enter name..') }}">
                                @if ($errors->has('name'))
                            ...
                            <div class="form-group{{ $errors->has('email') ? ' has-error' : '' }} has-feedback">
                                <input type="text" name="email" id="email" class="form-control"
                                    value="{{ $client['email'] }}" placeholder="{{ __('Enter email address..') }}">
                                @if ($errors->has('email'))
                                <span class="help-block">
                            ...
                            <div class="form-group{{ $errors->has('web') ? ' has-error' : '' }} has-feedback">
                                <input type="text" name="web" id="web" class="form-control" value="{{ $client['web'] }}"
                                    placeholder="{{ __('Enter web..') }}">
                                @if ($errors->has('web'))
                                <span class="help-block">
                            ...
                            <div class="form-group{{ $errors->has('date_of_birth') ? ' has-error' : '' }} has-feedback">
                                <div class="input-group date">
                                    ...
                                    <input type="text" name="date_of_birth" class="form-control pull-right"
                                        value="{{ $client['date_of_birth'] }}" id="datepicker">
                                </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <div
                                ...
                                <input type="text" name="present_address" id="present_address" class="form-control"
                                    value="{{ $client['present_address'] }}" placeholder="{{ __('Enter address..') }}">
                            ...
                            <div
                                class="form-group{{ $errors->has('contact_no_two') ? ' has-error' : '' }} has-feedback">
                                <input type="text" name="contact_no_two" id="contact_no_two" class="form-control"
                                    value="{{ $client['contact_no_two'] }}" placeholder="{{ __('Enter address..') }}">
                            ...
                            <label for="client_type_id">{{ __('Client Type') }} <span
                                    class="text-danger">*</span></label>
                            <div
                                class="form-group{{ $errors->has('client_type_id') ? ' has-error' : '' }} has-feedback">
