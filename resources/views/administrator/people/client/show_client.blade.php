...
<div class="content-wrapper">
    ...
    <section class="content">
        ...
        <div class="box bt-none">
            ...
            <div class="box-body">
                <a href="{{ url('/people/clients') }}" class="btn btn-primary btn-flat"><i
                ...
                <div class="btn-group btn-group-justified">
                    ...
                    <div class="btn-group">
                        <a href="{{ url('/people/clients/deactive/' . $client->id)}}"
                    ...
                    @else
                    <div class="btn-group">
                        <a href="{{ url('/people/clients/active/' . $client->id)}}" class="tip btn btn-warning btn-flat"
                    ...
                    <div class="btn-group">
                        <a href="{{ url('/people/clients/download-pdf/' . $client->id) }}"
                    ...
                    <div class="btn-group">
                        <a href="{{ url('/people/clients/edit/' . $client->id) }}"
                    ...
                    <div class="btn-group">
                        <a href="{{ url('/people/clients/delete/' . $client->id) }}" class="tip btn btn-danger btn-flat"
