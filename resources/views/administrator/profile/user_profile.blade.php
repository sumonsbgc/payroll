...
<div class="content-wrapper">
    ...
    <section class="content">
        ...
        <div class="box box-default bt-none">
            ...
            <!-- /.box-header -->
            <form action="{{ url('/profile/update-profile') }}" method="post" name="user_edit_form"
                ...
                <div class="box-body">
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            @else
                            <p class="text-yellow">{{ __('You can update your profile. All') }} (<span
                                    class="text-danger">*</span>) {{ __('field are required.') }} </p>
                            @endif
                        </div>
                        <!-- /.Notification Box -->
                        ...
                        <div class="col-md-6">
                            ...
                            <div
                                ...
                                <input type="text" name="contact_no_one" id="contact_no_one" class="form-control"
                                    value="{{ $user['contact_no_one'] }}" placeholder="{{ __('Enter contact no..') }}">
                        ...
                        <div class="col-md-6">
                            ...
                            <div
                                ...
                                <input type="text" name="present_address" id="present_address" class="form-control"
                                    value="{{ $user['present_address'] }}" placeholder="{{ __('Enter contact no..') }}">
                            ...
                            <label for="permanent_address">{{ __('Permanent Address') }} <span
                                    class="text-danger">*</span></label>
                            <div
                            ...
                            <div class="form-group{{ $errors->has('date_of_birth') ? ' has-error' : '' }} has-feedback">
                                <div class="input-group date">
                                    ...
                                    <input type="text" name="date_of_birth" class="form-control pull-right"
                                        value="{{ $user['date_of_birth'] }}" id="datepicker">
                                </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <img src="{{ url('/public/profile_picture/' . $user['avatar']) }}" alt="$user['avatar']"
