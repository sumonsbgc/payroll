...
class IncrementController extends Controller
{
    ...
    public function salaryStatementView(Request $request)
    {
        ...
        if ($request->daterange=='' or $empid=='') {
            ...
            $salarysheets= DB::table('salary_payments')->whereBetween('payment_month', [$startdate, $enddate])->where('user_id', $empid)->get();
            $datetotal= DB::table('salary_payments')->whereBetween('payment_month', [$startdate, $enddate])->where('user_id', $empid)->sum('gross_salary');
            // dd($salarysheets);
