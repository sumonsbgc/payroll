<div id="mainMenu">
    <ul class="sidebar-menu" data-widget="tree">
        <li><a href="<?php echo e(url('/dashboard')); ?>"><i class="fa fa-dashboard text-purple"></i>
                <span><?php echo e(__('Dashboard')); ?></span></a></li>
        ...
        <li class="treeview">
            ...
            <ul class="treeview-menu">
                ...
                <li><a href="<?php echo e(url('/people/employees')); ?>"><i class="fa fa-circle-o"></i>
                        <?php echo e(__('Manage Employee')); ?></a></li>
    ...
    <li><a href="<?php echo e(url('/hrm/salary/statement/search')); ?>"><i class="fa fa-certificate"></i>
            <span><?php echo e(__('Salary Statement')); ?></span></a></li>
    <?php endif; // Entrust::can ?>
    ...
    <li class="treeview">
        ...
        <ul class="treeview-menu">
            <?php if (\Entrust::can('manage-expense')) : ?>
            <li><a href="<?php echo e(url('/hrm/expence/category/add')); ?>"><i class="fa fa-circle-o"></i>
                    <span><?php echo e(__('New Expense Category')); ?></span></a></li>
            <li><a href="<?php echo e(url('/hrm/expence/category/list')); ?>"><i class="fa fa-circle-o"></i>
                    <span><?php echo e(__('Expense Category List')); ?></span></a></li>
            <li><a href="<?php echo e(url('/hrm/expence/add-expence')); ?>"><i class="fa fa-circle-o"></i>
                    <span><?php echo e(__('Create Expense')); ?></span></a></li>
            <li><a href="<?php echo e(url('/hrm/expence/manage-expence')); ?>"><i class="fa fa-circle-o"></i>
                    <span><?php echo e(__('Expense List')); ?></span></a></li>
            <?php endif; // Entrust::can ?>
        </ul>
    </li>
    <?php endif; // Entrust::can ?>
    ...
    <li class="treeview">
        ...
        <ul class="treeview-menu">
            ...
            <li><a href="<?php echo e(url('/hrm/application_lists')); ?>"><i class="fa fa-circle-o"></i>
                    <span><?php echo e(__('Leave Application List')); ?></span></a></li>
            <?php endif; // Entrust::can ?>
            <?php if (\Entrust::can('my-leave-application')) : ?>
            <li><a href="<?php echo e(url('/hrm/leave_application/create')); ?>"><i class="fa fa-circle-o"></i>
                    <span><?php echo e(__('New Leave Application')); ?></span></a></li>
            <li><a href="<?php echo e(url('/hrm/leave_application')); ?>"><i class="fa fa-circle-o"></i>
                    <span><?php echo e(__('Leave Application Manage')); ?></span></a></li>
            <?php endif; // Entrust::can ?>
            <?php if (\Entrust::can('leave-reports')) : ?>
            <li><a href="<?php echo e(url('/hrm/leave-reports')); ?>"><i class="fa fa-circle-o"></i>
                    <span><?php echo e(__('Leave Reports')); ?></span></a></li>
            <?php endif; // Entrust::can ?>
        </ul>
    </li>
    <?php endif; // Entrust::can ?>
    ...
    <li class="treeview">
        ...
        <ul class="treeview-menu">
            ...
            <li><a href="<?php echo e(url('hrm/notice/create')); ?>"><i class="fa fa-circle-o"></i><?php echo e(__('New Notice')); ?></a>
            </li>
            <?php endif; // Entrust::can ?>
            <?php if (\Entrust::can('notice-board')) : ?>
            <li><a href="<?php echo e(url('/hrm/notice/show')); ?>"><i class="fa fa-circle-o"></i>
                    <span><?php echo e(__('Notice list')); ?></span></a></li>
    ...
    <li class="treeview">
        ...
        <ul class="treeview-menu">
            <?php if (\Entrust::can('file-upload')) : ?>
            <li><a href="<?php echo e(url('/folders/create')); ?>"><i class="fa fa-circle-o"></i>
                    <span><?php echo e(__('New Upload')); ?></span></a></li>
            <li><a href="<?php echo e(url('/folders')); ?>"><i class="fa fa-circle-o"></i> <span><?php echo e(__('File List')); ?></span></a>
            </li>
            <?php endif; // Entrust::can ?>
    ...
    <li><a href="<?php echo e(url('/setting/departments')); ?>"><i class="fa fa-circle-o"></i><?php echo e(__('Manage Departments')); ?>

        </a></li>
    <li><a href="<?php echo e(url('/setting/designations')); ?>"><i class="fa fa-circle-o"></i><?php echo e(__('Manage Designations')); ?> </a>
    </li>
    <li><a href="<?php echo e(url('/setting/leave_categories')); ?>"><i class="fa fa-circle-o"></i><?php echo e(__('Manage Leave Categories')); ?> </a></li>
    <li><a href="<?php echo e(url('/setting/working-days')); ?>"><i class="fa fa-circle-o"></i>
            <?php echo e(__('Set Working Day')); ?></a></li>
    <li><a href="<?php echo e(url('/setting/holidays')); ?>"><i class="fa fa-circle-o"></i><?php echo e(__('Holiday List')); ?> </a>
    </li>
    
    
    <?php if (\Entrust::can('role')) : ?>
    <li><a href="<?php echo e(route('setting.role.index')); ?>"><i class="fa fa-circle-o"></i><?php echo e(__('Role')); ?></a></li>
    <li><a href="<?php echo e(route('setting.option.index')); ?>"><i class="fa fa-circle-o"></i><?php echo e(__('App Options')); ?></a></li>
    <?php endif; // Entrust::can ?>
    </ul>
    </li>
    <?php endif; // Entrust::can ?>

    <li><a href="<?php echo e(url('/profile/user-profile')); ?>"><i class="fa fa-user text-purple"></i>
            <span><?php echo e(__('Profile')); ?></span></a></li>
    <li><a href="<?php echo e(url('/profile/change-password')); ?>"><i class="fa fa-key text-purple"></i>
            <span><?php echo e(__('Change Password')); ?></span></a></li>
    <li>
...
</div><?php /**PATH /var/www/projects/payroll/resources/views/administrator/layouts/menu.blade.php ENDPATH**/ ?>