                    ...
                    <table class="table table-bordered table-striped">
                        <thead>
                            <tr>
                                ...
                                <?php for($i=1; $i<=$number_of_days; $i++): ?> <th class="text-center"><?php echo e($i); ?></th>
                                    <?php endfor; ?>
                            </tr>
                        </thead>
                        <tbody>
                            ...
                            <tr>
                                ...
                                <?php for($i = 1; $i <= $number_of_days; $i++): ?> <td class="text-center">
                                    <?php if($i>=1 AND $i<=9): ?> <?php ($day=$date."-0".$i); ?> <?php else: ?> <?php ($day=$date."-".$i); ?> <?php endif; ?>
                                        <?php ($day_name=date("D", strtotime($day))); ?> <?php $__currentLoopData = $monthly_holidays; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $monthly_holiday): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> <?php if($day==$monthly_holiday['date']): ?> <span
                                        class="btn btn-xs btn-danger btn-flat" data-toggle="tooltip"
                                        data-original-title="<?php echo e($monthly_holiday['holiday_name']); ?>">
                                        <?php echo e(__('H')); ?></span>
                                        <?php endif; ?>
...
<?php echo $__env->make('administrator.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/projects/payroll/resources/views/administrator/hrm/attendance/get_report.blade.php ENDPATH**/ ?>