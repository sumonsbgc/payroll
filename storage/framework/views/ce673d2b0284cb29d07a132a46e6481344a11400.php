...
<div class="content-wrapper">
    ...
    <section class="content">
        ...
        <div class="box bt-none">
            ...
            <div class="box-body">
                <div class="col-md-6">
                    <a href="<?php echo e(url('/hrm/leave_application/create')); ?>" class="btn btn-primary btn-flat"><i
                            class="fa fa-plus"></i> <?php echo e(__('Add leave application')); ?></a>
                </div>
                <div class="col-md-6">
                    ...
                    <table class="table table-bordered table-striped">
                        ...
                        <tbody id="myTable">
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    ...
                                    <a href="" class="btn btn-warning btn-xs btn-flat btn-block" data-toggle="tooltip"
                                        data-original-title="Pending"><i
                                            class="icon fa fa-hourglass-2"></i><?php echo e(__('Pending')); ?> </a>
                                ...
                                <td class="text-center">
                                    <a href="<?php echo e(url('/hrm/leave_application/' .$leave_application['id'])); ?>"><i
                                            class="icon fa fa-file-text"></i> <?php echo e(__('Details')); ?></a>
                                </td>
                            </tr>
...
<?php echo $__env->make('administrator.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/projects/payroll/resources/views/administrator/hrm/leave_application/manage_application.blade.php ENDPATH**/ ?>