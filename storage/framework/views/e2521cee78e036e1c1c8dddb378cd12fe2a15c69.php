      ...
      <form action="<?php echo e(url('/hrm/employee-awards/store')); ?>" method="post" name="employee_award_add_form">
        ...
        <div class="box-body">
          <div class="row">
            ...
            <div class="col-md-6">
              ...
              <div class="form-group<?php echo e($errors->has('gift_item') ? ' has-error' : ''); ?> has-feedback">
                <input type="text" name="gift_item" id="gift_item" class="form-control" value="<?php echo e(old('gift_item')); ?>"
                  placeholder="<?php echo e(__('Enter Gift Item..')); ?>">
              ...
              <div class="form-group<?php echo e($errors->has('description') ? ' has-error' : ''); ?> has-feedback">
                <textarea class="textarea text-description" name="description" id="description"
                  placeholder="<?php echo e(__('Enter employee award description..')); ?>"><?php echo e(old('description')); ?></textarea>
          ...
          <div class="box-footer">
            <a href="<?php echo e(url('/hrm/employee-awards')); ?>" class="btn btn-danger btn-flat"><i
...
<?php echo $__env->make('administrator.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/projects/payroll/resources/views/administrator/hrm/employee_awards/add_employee_award.blade.php ENDPATH**/ ?>