                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group<?php echo e($errors->has('loan_name') ? ' has-error' : ''); ?> has-feedback">
                                <input type="text" name="loan_name" id="loan_name" class="form-control"
                                    value="<?php echo e(old('loan_name')); ?>" placeholder="<?php echo e(__('Enter loan name..')); ?>">
                            ...
                            <label for="number_of_installments"><?php echo e(__('Number of Installment')); ?> <span
                            ...
                            <div
                                ...
                                <input type="text" name="number_of_installments" class="form-control pull-right"
                                    value="<?php echo e(old('number_of_installments')); ?>" id="number_of_installments"
                                    placeholder="<?php echo e(__('Enter number of installment')); ?>">
                            ...
                            <div class="form-group<?php echo e($errors->has('loan_amount') ? ' has-error' : ''); ?> has-feedback">
                                <input type="text" name="loan_amount" id="loan_amount" class="form-control"
                                    value="<?php echo e(old('loan_amount')); ?>" placeholder="<?php echo e(__('Enter loan name..')); ?>">
                        ...
                        <div class="col-md-12">
                            ...
                            <div
                                ...
                                <textarea class="textarea text-description" name="loan_description"
                                    id="loan_description"
                                    placeholder="<?php echo e(__('Enter client description..')); ?>"><?php echo e(old('loan_description')); ?></textarea>
...
<?php echo $__env->make('administrator.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/projects/payroll/resources/views/administrator/hrm/loan/add_loan.blade.php ENDPATH**/ ?>