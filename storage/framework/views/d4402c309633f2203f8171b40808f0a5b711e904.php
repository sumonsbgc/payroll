                        ...
                        <tbody id="myTable">
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    ...
                                    <a href="" class="btn btn-warning btn-xs btn-flat btn-block" data-toggle="tooltip"
                                        data-original-title="Pending"><i class="icon fa fa-hourglass-2"></i>
                                        <?php echo e(__('Pending')); ?></a>
                                    <?php elseif($leave_application['publication_status'] == 1): ?>
                                    <a href="" class="btn btn-success btn-xs btn-flat btn-block" data-toggle="tooltip"
                                        data-original-title="Accepted"><i class="icon fa fa-smile-o">
                                            <?php echo e(__('Accepted')); ?></i></a>
                                    <?php else: ?>
                                    <a href="" class="btn btn-danger btn-xs btn-flat btn-block" data-toggle="tooltip"
                                        data-original-title="Not Accepted"><i class="icon fa fa-flag"></i>
                                        <?php echo e(__('Not Accepted')); ?></a>
                                    <?php endif; ?>
                                </td>

                                <td class="text-center">
                                    <div class="btn-group">
                                        <button type="button" class="btn btn-primary btn-xs btn-flat dropdown-toggle"
                                            data-toggle="dropdown" aria-expanded="false">
                                            <?php echo e(__('Action')); ?> <span class="caret"></span>
                                        </button>
                                        <ul class="dropdown-menu" role="menu">
                                            <li><a
                                                    href="<?php echo e(url('/hrm/application_lists/' .$leave_application['id'])); ?>"><i
                                                        class="icon fa fa-file-text"></i> <?php echo e(__('Details')); ?></a></li>

                                            <li><a
                                                    href="<?php echo e(url('/hrm/leave_application/approved/' .$leave_application['id'])); ?>"><i
                                                        class="icon fa fa-file-text"></i> <?php echo e(__('Approved')); ?></a></li>

                                            <li><a
                                                    href="<?php echo e(url('/hrm/leave_application/not_approved/' .$leave_application['id'])); ?>"><i
                                                        class="icon fa fa-file-text"></i> <?php echo e(__('Not Approed')); ?></a>
                                            </li>
...
<?php echo $__env->make('administrator.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/projects/payroll/resources/views/administrator/hrm/leave_application/manage_application_lists.blade.php ENDPATH**/ ?>