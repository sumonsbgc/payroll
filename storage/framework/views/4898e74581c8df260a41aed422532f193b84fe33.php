...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            <li><a href="<?php echo e(url('/dashboard')); ?>"><i class="fa fa-dashboard"></i> <?php echo e(__('Dashboard')); ?>Dashboard</a>
            </li>
            <li><a href="<?php echo e(url('/people/references')); ?>"><?php echo e(__('References')); ?></a></li>
            <li class="active"><?php echo e(__('Add reference')); ?></li>
        </ol>
    </section>
    ...
    <section class="content">
        ...
        <div class="box box-default bt-none">
            <div class="box-header with-border">
                <h3 class="box-title"><?php echo e(__('Add reference')); ?></h3>
            ...
            <!-- /.box-header -->
            <form action="<?php echo e(url('people/references/store')); ?>" method="post" name="reference_add_form">
                ...
                <div class="box-body">
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            <?php else: ?>
                            <p class="text-yellow"><?php echo e(__('Enter reference type details. All field are required.')); ?>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group<?php echo e($errors->has('email') ? ' has-error' : ''); ?> has-feedback">
                                <input type="text" name="email" id="email" class="form-control"
                                    value="<?php echo e(old('email')); ?>" placeholder="<?php echo e(__('Enter email address..')); ?>">
                            ...
                            <div
                                ...
                                <input type="text" name="contact_no_one" id="contact_no_one" class="form-control"
                                    value="<?php echo e(old('contact_no_one')); ?>" placeholder="<?php echo e(__('Enter contact no..')); ?>">
                            ...
                            <div class="form-group<?php echo e($errors->has('web') ? ' has-error' : ''); ?> has-feedback">
                                <input type="text" name="web" id="web" class="form-control" value="<?php echo e(old('web')); ?>"
                                    placeholder="<?php echo e(__('Enter web..')); ?>">
                            ...
                            <div class="form-group<?php echo e($errors->has('date_of_birth') ? ' has-error' : ''); ?> has-feedback">
                                <div class="input-group date">
                                    ...
                                    <input type="text" name="date_of_birth" class="form-control pull-right"
                                        value="<?php echo e(old('date_of_birth')); ?>" id="datepicker">
                                </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <div
                                ...
                                <input type="text" name="present_address" id="present_address" class="form-control"
                                    value="<?php echo e(old('present_address')); ?>" placeholder="<?php echo e(__('Enter address..')); ?>">
                            ...
                            <div
                                class="form-group<?php echo e($errors->has('contact_no_two') ? ' has-error' : ''); ?> has-feedback">
                                <input type="text" name="contact_no_two" id="contact_no_two" class="form-control"
                                    value="<?php echo e(old('contact_no_two')); ?>" placeholder="<?php echo e(__('Enter address..')); ?>">
                ...
                <div class="box-footer">
                    <a href="<?php echo e(url('/people/references')); ?>" class="btn btn-danger btn-flat"><i
                            class="icon fa fa-close"></i> <?php echo e(__('Cancel')); ?></a>
                    <button type="submit" class="btn btn-primary btn-flat"><i
                            class="icon fa fa-plus"></i><?php echo e(__(' Add reference')); ?></button>
                </div>
            </form>
        </div>
        <!-- /.box -->
...
<script type="text/javascript">
    document.forms['reference_add_form'].elements['gender'].value = "<?php echo e(old('gender')); ?>";
    document.forms['reference_add_form'].elements['designation_id'].value = "<?php echo e(old('designation_id')); ?>";
</script>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('administrator.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/projects/payroll/resources/views/administrator/people/reference/add_reference.blade.php ENDPATH**/ ?>