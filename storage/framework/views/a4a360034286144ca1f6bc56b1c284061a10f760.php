            ...
            <form action="<?php echo e(url('setting/client-types/store')); ?>" method="post" name="client_type_add_form">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group<?php echo e($errors->has('client_type') ? ' has-error' : ''); ?> has-feedback">
                                <input type="text" name="client_type" id="client_type" class="form-control"
                                    value="<?php echo e(old('client_type')); ?>" placeholder="<?php echo e(__('Enter client name..')); ?>">
                        ...
                        <div class="col-md-12">
                            ...
                            <div
                                ...
                                <textarea class="textarea text-description" name="client_type_description"
                                    ...
                                    placeholder="<?php echo e(__('Enter client description..')); ?>"><?php echo e(old('client_type_description')); ?></textarea>
                                <?php if($errors->has('client_type')): ?>
                                <span class="help-block">
                ...
                <div class="box-footer">
                    ...
                    <button type="submit" class="btn btn-primary btn-flat"><i class="icon fa fa-plus"></i>
                        <?php echo e(__('Add client type')); ?></button>
                </div>
            </form>
        </div>
        <!-- /.box -->
...
<?php echo $__env->make('administrator.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/projects/payroll/resources/views/administrator/setting/client_type/add_client_type.blade.php ENDPATH**/ ?>