...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active"><?php echo e(__('Edit client')); ?></li>
        </ol>
    </section>
    ...
    <section class="content">
        ...
        <div class="box box-default bt-none">
            <div class="box-header with-border">
                <h3 class="box-title"><?php echo e(__('Edit client')); ?></h3>
            ...
            <!-- /.box-header -->
            <form action="<?php echo e(url('people/clients/update/'.$client['id'])); ?>" method="post" name="client_edit_form">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group<?php echo e($errors->has('name') ? ' has-error' : ''); ?> has-feedback">
                                <input type="text" name="name" id="name" class="form-control"
                                    value="<?php echo e($client['name']); ?>" placeholder="<?php echo e(__('Enter name..')); ?>">
                            ...
                            <div class="form-group<?php echo e($errors->has('email') ? ' has-error' : ''); ?> has-feedback">
                                <input type="text" name="email" id="email" class="form-control"
                                    value="<?php echo e($client['email']); ?>" placeholder="<?php echo e(__('Enter email address..')); ?>">
                            ...
                            <div
                                ...
                                <input type="text" name="contact_no_one" id="contact_no_one" class="form-control"
                                    value="<?php echo e($client['contact_no_one']); ?>"
                            ...
                            <div class="form-group<?php echo e($errors->has('web') ? ' has-error' : ''); ?> has-feedback">
                                <input type="text" name="web" id="web" class="form-control" value="<?php echo e($client['web']); ?>"
                            ...
                            <div class="form-group<?php echo e($errors->has('date_of_birth') ? ' has-error' : ''); ?> has-feedback">
                                <div class="input-group date">
                                    ...
                                    <input type="text" name="date_of_birth" class="form-control pull-right"
                                        value="<?php echo e($client['date_of_birth']); ?>" id="datepicker">
                                </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <div
                                ...
                                <input type="text" name="present_address" id="present_address" class="form-control"
                                    value="<?php echo e($client['present_address']); ?>" placeholder="<?php echo e(__('Enter address..')); ?>">
                            ...
                            <div
                                ...
                                <input type="text" name="contact_no_two" id="contact_no_two" class="form-control"
                                    value="<?php echo e($client['contact_no_two']); ?>" placeholder="<?php echo e(__('Enter address..')); ?>">
                            ...
                            <label for="client_type_id"><?php echo e(__('Client Type')); ?> <span
                                    class="text-danger">*</span></label>
                            <div
                                class="form-group<?php echo e($errors->has('client_type_id') ? ' has-error' : ''); ?> has-feedback">
                ...
                <div class="box-footer">
                    <a href="<?php echo e(url('/people/clients')); ?>" class="btn btn-danger btn-flat"><i
                    ...
                    <button type="submit" class="btn btn-primary btn-flat"><i class="icon fa fa-plus"></i>
                        <?php echo e(__('Update client')); ?></button>
                </div>
            </form>
        </div>
        <!-- /.box -->
...
<script type="text/javascript">
    document.forms['client_edit_form'].elements['gender'].value = "<?php echo e($client['gender']); ?>";
    document.forms['client_edit_form'].elements['client_type_id'].value = "<?php echo e($client['client_type_id']); ?>";
</script>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('administrator.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/projects/payroll/resources/views/administrator/people/client/edit_client.blade.php ENDPATH**/ ?>