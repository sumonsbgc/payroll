...
<?php $__env->startSection('title', __('Add job type')); ?>
...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active"><?php echo e(__('Add job type')); ?></li>
        </ol>
    </section>
    ...
    <section class="content">
        ...
        <div class="box box-default bt-none">
            <div class="box-header with-border">
                <h3 class="box-title"><?php echo e(__('Add job type')); ?></h3>
            ...
            <!-- /.box-header -->
            <form action="<?php echo e(url('setting/job-types/store')); ?>" method="post" name="job_type_add_form">
                ...
                <div class="box-body">
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            <?php else: ?>
                            <p class="text-yellow"><?php echo e(__('Enter job type details. All field are required.')); ?> </p>
                            <?php endif; ?>
                        </div>
                        <!-- /.Notification Box -->
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group<?php echo e($errors->has('job_type') ? ' has-error' : ''); ?> has-feedback">
                                <input type="text" name="job_type" id="job_type" class="form-control"
                                    value="<?php echo e(old('job_type')); ?>" placeholder="<?php echo e(__('Enter job name..')); ?>">
                        ...
                        <div class="col-md-12">
                            ...
                            <div
                                ...
                                <textarea class="textarea text-description" name="job_type_description"
                                    ...
                                    placeholder="<?php echo e(__('Enter job description..')); ?>"><?php echo e(old('job_type_description')); ?></textarea>
                                <?php if($errors->has('job_type')): ?>
                                <span class="help-block">
                ...
                <div class="box-footer">
                    ...
                    <button type="submit" class="btn btn-primary btn-flat"><i class="icon fa fa-plus"></i>
                        <?php echo e(__('Add job type')); ?></button>
                </div>
            </form>
        </div>
        <!-- /.box -->
...
<script type="text/javascript">
    document.forms['job_type_add_form'].elements['publication_status'].value = "<?php echo e(old('publication_status')); ?>";
</script>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('administrator.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/projects/payroll/resources/views/administrator/setting/job_type/add_job_type.blade.php ENDPATH**/ ?>