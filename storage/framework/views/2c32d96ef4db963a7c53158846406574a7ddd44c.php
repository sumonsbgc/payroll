        ...
        <div class="box-body">
          <div class="row">
            ...
            <div class="col-md-12">
              ...
              <?php else: ?>
              <p class="text-yellow"><?php echo e(__('Enter Awards Title. All field are required.')); ?> </p>
              <?php endif; ?>
            </div>
            <!-- /.Notification Box -->
            ...
            <div class="col-md-6">
              ...
              <div class="form-group<?php echo e($errors->has('award_title') ? ' has-error' : ''); ?> has-feedback">
                <input type="text" name="award_title" id="award_title" class="form-control"
                  value="<?php echo e(old('award_title')); ?>" placeholder="<?php echo e(__('Enter Award Name/Title..')); ?>">
...
<?php echo $__env->make('administrator.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/projects/payroll/resources/views/administrator/setting/employee_award/award_category/add_award_category.blade.php ENDPATH**/ ?>