    ...
    <div class="box box-default bt-none">
      ...
      <form action="<?php echo e(url('hrm/notice/store')); ?>" method="post" name="notice_add_form">
            ...
            <div class="col-md-6">
              ...
              <div class="form-group<?php echo e($errors->has('notice_title') ? ' has-error' : ''); ?> has-feedback">
                <input type="text" name="notice_title" id="notice_title" class="form-control"
                  value="<?php echo e(old('notice_title')); ?>" placeholder="<?php echo e(__('Enter notice title..')); ?>">
            ...
            <div class="col-md-12">
              ...
              <div class="form-group<?php echo e($errors->has('description') ? ' has-error' : ''); ?> has-feedback">
                <textarea class="textarea text-description" name="description" id="description"
                  placeholder="<?php echo e(__('Enter Notice description..')); ?>"><?php echo e(old('description')); ?></textarea>
        ...
        <div class="box-footer">
          <a href="<?php echo e(url('/hrm/notice')); ?>" class="btn btn-danger btn-flat"><i class="icon fa fa-close"></i>
            <?php echo e(__('Cancel')); ?></a>
          <button type="submit" class="btn btn-primary btn-flat"><i class="icon fa fa-plus"></i>
            <?php echo e(__('Add Notice')); ?></button>
        </div>
      </form>
    </div>
    <!-- /.box -->
...
<?php echo $__env->make('administrator.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/projects/payroll/resources/views/administrator/hrm/notice/add_notice.blade.php ENDPATH**/ ?>