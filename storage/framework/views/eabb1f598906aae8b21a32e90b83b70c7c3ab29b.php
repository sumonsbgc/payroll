...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active"><?php echo e(__('Edit Deduction')); ?></li>
        </ol>
    </section>
    ...
    <section class="content">
        ...
        <div class="box box-default bt-none">
            <div class="box-header with-border">
                <h3 class="box-title"><?php echo e(__('Edit Deduction')); ?></h3>
            ...
            <!-- /.box-header -->
            <form action="<?php echo e(url('/hrm/deductions/update/' . $deduction['id'])); ?>" method="post" name="deduction_add_form">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group<?php echo e($errors->has('deduction_name') ? ' has-error' : ''); ?> has-feedback">
                                <input type="text" name="deduction_name" id="deduction_name" class="form-control" value="<?php echo e($deduction['deduction_name']); ?>" placeholder="<?php echo e(__('Enter deduction name..')); ?>">
                            ...
                            <div class="form-group<?php echo e($errors->has('deduction_month') ? ' has-error' : ''); ?> has-feedback">
                                <div class="input-group date">
                                    ...
                                    <input type="text" name="deduction_month" class="form-control pull-right" value="<?php echo e($deduction['deduction_month']); ?>" id="monthpicker2">
                                </div>
                            ...
                            <div class="form-group<?php echo e($errors->has('deduction_amount') ? ' has-error' : ''); ?> has-feedback">
                                <input type="number" name="deduction_amount" id="deduction_amount" class="form-control" value="<?php echo e($deduction['deduction_amount']); ?>" placeholder="<?php echo e(__('Enter deduction name..')); ?>">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="form-group<?php echo e($errors->has('deduction_description') ? ' has-error' : ''); ?> has-feedback">
                                <textarea class="textarea text-description" name="deduction_description" id="deduction_description" placeholder="<?php echo e(__('Enter client description..')); ?>"><?php echo e($deduction['deduction_description']); ?></textarea>
                ...
                <div class="box-footer">
                    ...
                    <button type="submit" class="btn btn-primary btn-flat"><i class="icon fa fa-edit"></i> <?php echo e(__('Update deduction')); ?></button>
                </div>
            </form>
        </div>
        <!-- /.box -->
...
<script type="text/javascript">
    document.forms['deduction_add_form'].elements['user_id'].value = "<?php echo e($deduction['user_id']); ?>";
</script>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('administrator.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/projects/payroll/resources/views/administrator/hrm/deduction/edit_deduction.blade.php ENDPATH**/ ?>