                    ...
                    <div class="box-body box-profile">
                        ...
                        <ul class="list-group list-group-unbordered">
                            <li class="list-group-item">
                                <b><?php echo e(__('Created At:')); ?> <br>
                                    <?php echo e(date("D d F Y h:ia", strtotime($notice['created_at']))); ?> </b>
                            </li>
                            <li class="list-group-item">
            ...
            <div class="col-md-9">
                <div class="nav-tabs-custom">
                    <ul class="nav nav-tabs">
                        <li class="active"><a href="#job_details" data-toggle="tab"
                                aria-expanded="true"><?php echo e(__('Notice')); ?></a></li>
...
<?php echo $__env->make('administrator.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/projects/payroll/resources/views/administrator/hrm/notice/show_notice.blade.php ENDPATH**/ ?>