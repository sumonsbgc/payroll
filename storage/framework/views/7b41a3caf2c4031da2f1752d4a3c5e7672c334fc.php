            ...
            <div class="form-group<?php echo e($errors->has('salary_month') ? ' has-error' : ''); ?>">
              ...
              <div class="col-sm-6">
                <div class="input-group date">
                  ...
                  <input type="text" name="salary_month" id="monthpicker" class="form-control pull-right"
...
<?php echo $__env->make('administrator.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/projects/payroll/resources/views/administrator/hrm/salary_payment/generate_payslip.blade.php ENDPATH**/ ?>