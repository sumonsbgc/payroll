            ...
            <form action="<?php echo e(url('setting/leave_categories/store')); ?>" method="post" name="leave_category_add_form">
                ...
                <div class="box-body">
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            <?php else: ?>
                            <p class="text-yellow"><?php echo e(__('Enter leave_category details. All field are required.')); ?>
                        ...
                        <div class="col-md-6">
                            ...
                            <div
                                ...
                                <input type="text" name="leave_category" id="leave_category" class="form-control"
                                    value="<?php echo e(old('leave_category')); ?>" placeholder="<?php echo e(__('Enter client name..')); ?>">
                        ...
                        <div class="col-md-12">
                            ...
                            <div
                                ...
                                <textarea class="textarea text-description" name="leave_category_description"
                                    ...
                                    placeholder="<?php echo e(__('Enter client description..')); ?>"><?php echo e(old('leave_category_description')); ?></textarea>
                                <?php if($errors->has('leave_category')): ?>
                                <span class="help-block">
                ...
                <div class="box-footer">
                    ...
                    <button type="submit" class="btn btn-primary btn-flat"><i
                            class="icon fa fa-plus"></i><?php echo e(__('Add leave category')); ?> </button>
                </div>
            </form>
        </div>
        <!-- /.box -->
...
<?php echo $__env->make('administrator.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/projects/payroll/resources/views/administrator/setting/leave_category/add_leave_category.blade.php ENDPATH**/ ?>