    ...
    <div class="row myrow">
      <div class="col-lg-6">
        <div class="panel panel-default">
          <div class="panel-heading panel-title text-center bg-red">
            <strong><?php echo e(__('Holiday')); ?></strong>
          </div>
            ...
            <table class="table table-bordered table-striped">
              <thead>
                <tr>
                  ...
                  <th style="width: 150px;"><?php echo e(__('Holiday Name')); ?></th>
                  <th style="width: 130px;"><?php echo e(__('Dated')); ?></th>
          ...
          <div class="panel-body">
            <table class="table table-bordered table-striped">
              <thead>
                <tr>
                  <th><?php echo e(__('SL')); ?></th>
                  <th style="width: 150px;"><?php echo e(__('Title')); ?></th>
                  <th><?php echo e(__('Description')); ?></th>
                </tr>
              </thead>
              <tbody>
  ...
  <div class="box-body table-responsive no-padding">
    <table class="table table-bordered table-striped">
      ...
      <tr>
        ...
        <td><span class="label label-warning"><?php echo e(date("d F Y", strtotime($personal_event->start_date))); ?></span>
        </td>
...
<?php echo $__env->make('administrator.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/projects/payroll/resources/views/administrator/dashboard/dashboard.blade.php ENDPATH**/ ?>