...
<div class="content-wrapper">
    ...
    <section class="content">
        ...
        <div class="box box-default bt-none">
            ...
            <!-- /.box-header -->
            <form action="<?php echo e(url('people/references/update/'.$reference['id'])); ?>" method="post"
                name="reference_edit_form">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group<?php echo e($errors->has('name') ? ' has-error' : ''); ?> has-feedback">
                                <input type="text" name="name" id="name" class="form-control"
                                    value="<?php echo e($reference['name']); ?>" placeholder="<?php echo e(__('Enter name..')); ?>">
                            ...
                            <div class="form-group<?php echo e($errors->has('email') ? ' has-error' : ''); ?> has-feedback">
                                <input type="text" name="email" id="email" class="form-control"
                                    value="<?php echo e($reference['email']); ?>" placeholder="<?php echo e(__('Enter email address..')); ?>">
                            ...
                            <div
                                ...
                                <input type="text" name="contact_no_one" id="contact_no_one" class="form-control"
                                    value="<?php echo e($reference['contact_no_one']); ?>"
                            ...
                            <div class="form-group<?php echo e($errors->has('web') ? ' has-error' : ''); ?> has-feedback">
                                <input type="text" name="web" id="web" class="form-control"
                                    value="<?php echo e($reference['web']); ?>" placeholder="<?php echo e(__('Enter web..')); ?>">
                            ...
                            <div class="form-group<?php echo e($errors->has('date_of_birth') ? ' has-error' : ''); ?> has-feedback">
                                <div class="input-group date">
                                    ...
                                    <input type="text" name="date_of_birth" class="form-control pull-right"
                                        value="<?php echo e($reference['date_of_birth']); ?>" id="datepicker">
                                </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <div
                                ...
                                <input type="text" name="present_address" id="present_address" class="form-control"
                                    value="<?php echo e($reference['present_address']); ?>"
                            ...
                            <div
                                ...
                                <input type="text" name="contact_no_two" id="contact_no_two" class="form-control"
                                    value="<?php echo e($reference['contact_no_two']); ?>"
                                    placeholder="<?php echo e(__('Enter address..')); ?>">
                ...
                <div class="box-footer">
                    ...
                    <button type="submit" class="btn btn-primary btn-flat"><i class="icon fa fa-plus"></i>
                        <?php echo e(__('Update reference')); ?></button>
                </div>
            </form>
        </div>
        <!-- /.box -->
...
<?php echo $__env->make('administrator.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/projects/payroll/resources/views/administrator/people/reference/edit_reference.blade.php ENDPATH**/ ?>