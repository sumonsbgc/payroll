        ...
        <div class="box bt-none">
            ...
            <div class="box-body">
                <div class=" text-right">
                    ...
                    <a href="<?php echo e(url('hrm/salary/statement/search')); ?>" class="py-1 px-5 btn bg-green text-uppercase"><i
                            class="fa fa-plus"></i>
                        <?php echo e(__('add new Salary Statement')); ?></a>

                    <form action="<?php echo e(url('/hrm/salary/statement/preview')); ?>" method="get" class="d-inline-block">
                        ...
                        <button type="submit" class="btn bg-blue py-1 px-5 text-uppercase"><?php echo e(__('Preview')); ?>

                        </button>
                    </form>

                    <form action="<?php echo e(url('/hrm/salary/statement/pdf')); ?>" method="get" class="d-inline-block">
                        <?php echo e(csrf_field()); ?>

                        <input type="hidden" name="emp_id" value="<?php echo e($empid); ?>">
                        <input type="hidden" name="date1" value="<?php echo e($startdate); ?>">
                        <input type="hidden" name="date2" value="<?php echo e($enddate); ?>">
                        <button type="submit" class="btn bg-orange py-1 px-5"><?php echo e(__('PDF')); ?> </button>
                    </form>
                </div>
                <hr>
                ...
                <div class="st-left-body">
                    <h4>
                        ...
                        <?php 
                            $desig= \App\Designation::find($designation)->designation;
                        ?>
...
<?php echo $__env->make('administrator.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/projects/payroll/resources/views/administrator/hrm/increment/salaryStatementView.blade.php ENDPATH**/ ?>