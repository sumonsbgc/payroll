...
<body class="hold-transition login-page">
    ...
    <div class="login-box">
        <div class="login-logo">
            <a><b><?php echo e(__('HRM & Payroll')); ?></b></a>
        </div>
        <!-- /.login-logo -->
        <div class="login-box-body">
            ...
            <form action="<?php echo e(route('login')); ?>" method="post">
                ...
                <div class="form-group<?php echo e($errors->has('password') ? ' has-error' : ''); ?> has-feedback">
                    <input type="password" name="password" class="form-control" placeholder="<?php echo e(__('Password')); ?>" value="demo">
            ...
            <!--<form action="<?php echo e(route('login')); ?>" method="post">
                ...
                <div class="col-xs-6">
                    <button type="submit" class="btn btn-primary btn-block btn-flat"><?php echo e(__('Employee Login')); ?></button>
                </div>
            </form>-->
            <!-- /.col -->
        </div>
...
</html><?php /**PATH /var/www/projects/payroll/resources/views/administrator/login/login.blade.php ENDPATH**/ ?>