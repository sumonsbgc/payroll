...
<div class="content-wrapper">
    ...
    <section class="content">
        ...
        <div class="box bt-none">
            ...
            <div class="box-body">
                <div class="col-md-6">
                    <a href="<?php echo e(url('/hrm/employee-awards/create')); ?>" class="btn btn-primary btn-flat"><i
                            class="fa fa-plus"></i><?php echo e(__(' Add employee award')); ?></a>
                </div>
                    ...
                    <table class="table table-bordered table-striped">
                        ...
                        <tbody id="myTable">
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <a href="<?php echo e(url('/hrm/employee-awards/edit/' . $employee_aword['id'])); ?>"><i
...
<?php echo $__env->make('administrator.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/projects/payroll/resources/views/administrator/hrm/employee_awards/manage_employee_award.blade.php ENDPATH**/ ?>