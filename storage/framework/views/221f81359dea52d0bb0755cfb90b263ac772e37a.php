...
<div class="content-wrapper">
    ...
    <section class="content">
        ...
        <div class="box bt-none">
            ...
            <div class="box-body">
                <div class="col-md-6">
                    <a href="<?php echo e(url('/hrm/payroll')); ?>" class="btn btn-primary btn-flat"><i class="fa fa-edit"></i>
                        <?php echo e(__('Manage Salary')); ?></a>
                </div>
                    ...
                    <table class="table table-bordered table-striped">
                        ...
                        <tbody id="myTable">
                            ...
                            <tr>
                                ...
                                <td>
                                    <?php ($gross_salary = $salary['basic_salary'] + $salary['house_rent_allowance'] +
                                    $salary['medical_allowance'] + $salary['special_allowance'] +
                                    $salary['other_allowance']); ?>
                                    <?php echo e($gross_salary); ?>

                                </td>
                                <td>
                                    <?php ($total_deduction = $salary['tax_deduction'] +
                                    $salary['provident_fund_deduction'] + $salary['other_deduction']); ?>
                                ...
                                <td class="text-center">
                                    <a href="<?php echo e(url('/hrm/payroll/manage-salary/' . $salary['user_id'])); ?>"><i
...
<?php echo $__env->make('administrator.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/projects/payroll/resources/views/administrator/hrm/payroll/salary_list.blade.php ENDPATH**/ ?>