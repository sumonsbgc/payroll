            ...
            <form action="<?php echo e(url('setting/departments/store')); ?>" method="post" name="department_add_form">
                ...
                <div class="box-body">
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            <?php else: ?>
                            <p class="text-yellow"><?php echo e(__('Enter department details. All field are required.')); ?> </p>
                            <?php endif; ?>
                        </div>
                        <!-- /.Notification Box -->
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group<?php echo e($errors->has('department') ? ' has-error' : ''); ?> has-feedback">
                                <input type="text" name="department" id="department" class="form-control"
                                    value="<?php echo e(old('department')); ?>" placeholder="<?php echo e(__('Enter client name..')); ?>">
                        ...
                        <div class="col-md-12">
                            ...
                            <div
                                ...
                                <textarea class="textarea text-description" name="department_description"
                                    ...
                                    placeholder="<?php echo e(__('Enter client description..')); ?>"><?php echo e(old('department_description')); ?></textarea>
                                <?php if($errors->has('department')): ?>
                                <span class="help-block">
                ...
                <div class="box-footer">
                    ...
                    <button type="submit" class="btn btn-primary btn-flat"><i class="icon fa fa-plus"></i>
                        <?php echo e(__('Add departmen')); ?>t</button>
                </div>
            </form>
        </div>
        <!-- /.box -->
...
<?php echo $__env->make('administrator.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/projects/payroll/resources/views/administrator/setting/department/add_department.blade.php ENDPATH**/ ?>