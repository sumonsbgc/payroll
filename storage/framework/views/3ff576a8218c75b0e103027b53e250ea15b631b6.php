...
<div class="content-wrapper">
    ...
    <section class="content">
        ...
        <div class="box box-default bt-none">
            ...
            <!-- /.box-header -->
            <form action="<?php echo e(url('/profile/update-profile')); ?>" method="post" name="user_edit_form"
                ...
                <div class="box-body">
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            <?php else: ?>
                            <p class="text-yellow"><?php echo e(__('You can update your profile. All')); ?> (<span
                                    class="text-danger">*</span>) <?php echo e(__('field are required.')); ?> </p>
                            <?php endif; ?>
                        </div>
                        <!-- /.Notification Box -->
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group<?php echo e($errors->has('name') ? ' has-error' : ''); ?> has-feedback">
                                <input type="text" name="name" id="name" class="form-control"
                                    value="<?php echo e($user['name']); ?>" placeholder="<?php echo e(__('Enter name..')); ?>">
                            ...
                            <div class="form-group has-feedback">
                                <input type="text" id="email" class="form-control" value="<?php echo e($user['email']); ?>"
                                    disabled>
                            </div>
                            <!-- /.form-group -->
                            ...
                            <div
                                ...
                                <input type="text" name="contact_no_one" id="contact_no_one" class="form-control"
                                    value="<?php echo e($user['contact_no_one']); ?>" placeholder="<?php echo e(__('Enter contact no..')); ?>">
                            ...
                            <div class="form-group<?php echo e($errors->has('web') ? ' has-error' : ''); ?> has-feedback">
                                <input type="text" name="web" id="web" class="form-control" value="<?php echo e($user['web']); ?>"
                        ...
                        <div class="col-md-6">
                            ...
                            <div
                                ...
                                <input type="text" name="present_address" id="present_address" class="form-control"
                                    value="<?php echo e($user['present_address']); ?>" placeholder="<?php echo e(__('Enter contact no..')); ?>">
                            ...
                            <label for="permanent_address"><?php echo e(__('Permanent Address')); ?> <span
                                    class="text-danger">*</span></label>
                            <div
                                ...
                                <input type="text" name="permanent_address" id="permanent_address" class="form-control"
                                    value="<?php echo e($user['permanent_address']); ?>"
                                    placeholder="<?php echo e(__('Enter contact no..')); ?>">
                            ...
                            <div class="form-group<?php echo e($errors->has('date_of_birth') ? ' has-error' : ''); ?> has-feedback">
                                <div class="input-group date">
                                    ...
                                    <input type="text" name="date_of_birth" class="form-control pull-right"
                                        value="<?php echo e($user['date_of_birth']); ?>" id="datepicker">
                                </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <img src="<?php echo e(url('/public/profile_picture/' . $user['avatar'])); ?>" alt="$user['avatar']"
                ...
                <div class="box-footer">
                    <button type="submit" class="btn btn-primary btn-flat"><i class="icon fa fa-edit"></i>
                        <?php echo e(__('Update Profile')); ?></button>
                </div>
            </form>
        </div>
        <!-- /.box -->
...
<?php echo $__env->make('administrator.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/projects/payroll/resources/views/administrator/profile/user_profile.blade.php ENDPATH**/ ?>