        ...
        <div class="box box-default">
            ...
            <form action="<?php echo e(url('/setting/client-types/update/'. $client_type['id'])); ?>" method="post" name="client_type_edit_form">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="form-group<?php echo e($errors->has('client_type_description') ? ' has-error' : ''); ?> has-feedback">
                                <textarea class="textarea" name="client_type_description" id="client_type_description" placeholder="<?php echo e(__('Enter Description..')); ?>" class="text-description"><?php echo e($client_type['client_type_description']); ?></textarea>
                                <?php if($errors->has('client_type')): ?>
                                <span class="help-block">
                ...
                <div class="box-footer">
                    ...
                    <button type="submit" class="btn btn-primary btn-flat"><i class="icon fa fa-edit"></i> <?php echo e(__('Update client type')); ?></button>
                </div>
            </form>
        </div>
        <!-- /.box -->
...
<?php echo $__env->make('administrator.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/projects/payroll/resources/views/administrator/file/edit_client_type.blade.php ENDPATH**/ ?>