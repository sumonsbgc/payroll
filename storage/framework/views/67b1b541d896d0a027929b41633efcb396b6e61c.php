    ...
    <section class="content">
        ...
        <div class="box bt-none">
            ...
            <div class="box-body">
                ...
                <div class="col-md-3">
                    <a href="<?php echo e(url('/hrm/expence/category/add')); ?>" class="btn btn-primary btn-flat"><i
                            class="fa fa-plus"></i> <?php echo e(__('add new expense category')); ?></a>
                </div>
                <div class="col-md-3">
                    ...
                    <table class="table table-bordered table-striped">
                        ...
                        <tbody id="myTable">
                            ...
                            <tr>
                                ...
                                <td><a href="<?php echo e(url('/hrm/expence/category/edit/'.$expense->id)); ?>"
                                        class="btn btn-success"><?php echo e(__('Edit')); ?></a></td>
...
<?php echo $__env->make('administrator.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/projects/payroll/resources/views/administrator/hrm/expence/managePurposeExpense.blade.php ENDPATH**/ ?>