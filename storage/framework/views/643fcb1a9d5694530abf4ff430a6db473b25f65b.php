...
<div class="content-wrapper">
    ...
    <section class="content">
        ...
        <div class="box bt-none">
            ...
            <div class="box-body">
                <div class="col-md-3">
                    <a href="<?php echo e(url('/hrm/payroll/increment/search')); ?>" class="btn btn-primary btn-flat"><i
                            class="fa fa-plus"></i> <?php echo e(__('add new increment')); ?></a>
                </div>
                <div class="col-md-3">
...
<?php echo $__env->make('administrator.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/projects/payroll/resources/views/administrator/hrm/increment/incrementList.blade.php ENDPATH**/ ?>