            ...
            <form action="<?php echo e(url('people/clients/store')); ?>" method="post" name="client_add_form">
                        ...
                        <div class="col-md-6">
                            ...
                            <div
                                ...
                                <input type="text" name="contact_no_two" id="contact_no_two" class="form-control"
                                    value="<?php echo e(old('contact_no_two')); ?>" placeholder="<?php echo e(__('Enter contact no..')); ?>">
                ...
                <div class="box-footer">
                    ...
                    <button type="submit" class="btn btn-primary btn-flat"><i class="icon fa fa-plus"></i>
                        <?php echo e(__('Add client')); ?></button>
                </div>
            </form>
        </div>
        <!-- /.box -->
...
<?php echo $__env->make('administrator.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/projects/payroll/resources/views/administrator/people/client/add_client.blade.php ENDPATH**/ ?>