...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a><?php echo e(__('Customer')); ?></a></li>
    ...
    <section class="content">
        ...
        <div class="box bt-none">
            <div class="box-header with-border">
                <h3 class="box-title"><?php echo e(__('Manage Customer')); ?></h3>
            ...
            <div class="box-body">
                <div class="col-md-3">
                    <a href="<?php echo e(url('/people/clients/create')); ?>" class="btn btn-primary btn-flat"><i
                            class="fa fa-plus"></i> <?php echo e(__('Add Customer')); ?></a>
                </div>
                <div class="col-md-3">
                    ...
                    <table class="table table-bordered table-striped">
                        ...
                        <tbody id="myTable">
                            ...
                            <tr>
                                ...
                                <td class="text-center"><?php echo e(date("d F Y", strtotime($client['created_at']))); ?></td>

                                <td class="text-center">
                                    <a href="<?php echo e(url('/people/clients/edit/' . $client['id'])); ?>"><i
...
<?php echo $__env->make('administrator.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/projects/payroll/resources/views/administrator/people/client/manage_clients.blade.php ENDPATH**/ ?>