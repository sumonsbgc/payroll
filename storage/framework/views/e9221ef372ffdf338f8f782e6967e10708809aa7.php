    ...
    <section class="content">
        ...
        <div class="box bt-none">
            ...
            <div class="box-body">
                ...
                <div class="col-md-6">
                    <a href="<?php echo e(url('/setting/designations/create')); ?>" class="btn btn-primary btn-flat"><i
                    ...
                    <table class="table table-bordered table-striped">
                        ...
                        <tbody id="myTable">
                            ...
                            <tr>
                                ...
                                <td>
                                    <a
                                        href="<?php echo e(url('/setting/designations/edit/' . $designation['id'])); ?>"><?php echo e(__('Edit')); ?></a>
                                </td>
                            </tr>
...
<?php echo $__env->make('administrator.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/projects/payroll/resources/views/administrator/setting/designation/manage_designations.blade.php ENDPATH**/ ?>