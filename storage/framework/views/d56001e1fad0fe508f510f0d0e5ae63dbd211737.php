...
<div class="content-wrapper">
    ...
    <section class="content">
        ...
        <div class="box box-default bt-none">
            ...
            <!-- /.box-header -->
            <form action="<?php echo e(url('people/employees/update/'.$employee['id'])); ?>" method="post"
                ...
                <div class="box-body">
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            <?php else: ?>
                            <p class="text-yellow">
                                <?php echo e(__(' Enter team member details. All (*)field are required. (Default password for added user is 12345678)')); ?>
                        ...
                        <div class="col-md-3">
                            ...
                            <div class="form-group<?php echo e($errors->has('spouse_name') ? ' has-error' : ''); ?> has-feedback">
                                <input type="text" name="spouse_name" id="spouse_name" class="form-control"
                                    value="<?php echo e($employee['spouse_name']); ?>">
                        ...
                        <div class="col-md-3">
                            ...
                            <div class="form-group<?php echo e($errors->has('joining_date') ? ' has-error' : ''); ?> has-feedback">
                                <div class="input-group date">
                                    ...
                                    <input type="text" name="joining_date" value="<?php echo e($employee['joining_date']); ?>"
                                        class="form-control pull-right" id="datepicker4">
                                </div>
                        ...
                        <div class="col-md-3">
                            ...
                            <div
                                class="form-group<?php echo e($errors->has('permanent_address') ? ' has-error' : ''); ?> has-feedback">
                            ...
                            <div class="form-group<?php echo e($errors->has('home_district') ? ' has-error' : ''); ?> has-feedback">
                                <input type="text" name="home_district" id="home_district" class="form-control"
                                    value="<?php echo e($employee['home_district']); ?>">
                            ...
                            <div class="form-group<?php echo e($errors->has('id_number') ? ' has-error' : ''); ?> has-feedback">
                                <input type="text" name="id_number" id="id_number" class="form-control"
                                    value="<?php echo e($employee['id_number']); ?>">
                            ...
                            <div
                                class="form-group<?php echo e($errors->has('joining_position') ? ' has-error' : ''); ?> has-feedback">
                        ...
                        <div class="col-md-3">
                            ...
                            <div
                                class="form-group<?php echo e($errors->has('marital_status') ? ' has-error' : ''); ?> has-feedback">
                            ...
                            <div class="form-group<?php echo e($errors->has('date_of_birth') ? ' has-error' : ''); ?> has-feedback">
                                <div class="input-group date">
                                    ...
                                    <input type="text" name="date_of_birth" class="form-control pull-right"
                                        value="<?php echo e($employee['date_of_birth']); ?>" id="datepicker3">
                                </div>
                        ...
                        <div class="col-md-4">
                            ...
                            <div
                                ...
                                <textarea name="academic_qualification" id="academic_qualification"
                                    class="form-control textarea"><?php echo e($employee['academic_qualification']); ?></textarea>
                        ...
                        <div class="col-md-4">
                            ...
                            <div
                                ...
                                <textarea name="professional_qualification" id="professional_qualification"
                                    class="form-control textarea"><?php echo e($employee['professional_qualification']); ?></textarea>
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="form-group<?php echo e($errors->has('experience') ? ' has-error' : ''); ?> has-feedback">
                                <textarea name="experience" id="experience"
                                    class="form-control textarea"><?php echo e($employee['experience']); ?></textarea>
                    ...
                    <div class="box-footer">
                        <a href="<?php echo e(url('/people/employees')); ?>" class="btn btn-danger btn-flat"><i
...
<?php echo $__env->make('administrator.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/projects/payroll/resources/views/administrator/people/employee/edit_employee.blade.php ENDPATH**/ ?>