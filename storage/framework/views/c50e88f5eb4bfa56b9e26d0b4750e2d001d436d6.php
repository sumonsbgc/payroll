                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            ...
                            <div class="form-group<?php echo e($errors->has('fingerprint_user_id') ? ' has-error' : ''); ?> has-feedback">
                                <input type="text" name="fingerprint_user_id" id="fingerprint_user_id" class="form-control" value="<?php echo e(old('fingerprint_user_id')); ?>" placeholder="<?php echo e(__('Enter Fingerprint Registration ID..')); ?>">
...
<?php echo $__env->make('administrator.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/projects/payroll/resources/views/administrator/people/employee/add_employee.blade.php ENDPATH**/ ?>