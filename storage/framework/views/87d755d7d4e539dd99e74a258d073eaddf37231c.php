                        ...
                        <div class="col-md-12">
                            ...
                            <div
                                ...
                                <textarea class="textarea text-description" name="client_type_description"
                                    id="client_type_description"><?php echo e($client_type['client_type_description']); ?></textarea>
                                <?php if($errors->has('client_type')): ?>
                                <span class="help-block">
...
<?php echo $__env->make('administrator.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/projects/payroll/resources/views/administrator/people/reference/edit_client_type.blade.php ENDPATH**/ ?>