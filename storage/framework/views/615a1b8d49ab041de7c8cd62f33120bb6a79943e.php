<?php $__env->startSection('title', __('Reference Types')); ?>
    ...
    <section class="content">
        ...
        <div class="box bt-none">
            <div class="box-header with-border">
                <h3 class="box-title"><?php echo e(__('Details of reference')); ?></h3>
            ...
            <div class="box-body">
                <a href="<?php echo e(url('/people/references')); ?>" class="btn btn-primary btn-flat"><i
                    ...
                    <table class="table table-bordered table-striped">
                        <tbody id="myTable">
                            ...
                            <tr>
                                ...
                                <td><?php echo e($reference->contact_no_two); ?></td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td><?php echo e($reference->web); ?></td>
                            </tr>
                            <tr>
                                <td><?php echo e(__('Gender')); ?></td>
                                <td>
                                    <?php if($reference->gender == 'm'): ?>
                            ...
                            <tr>
                                ...
                                <td>
                                    <?php if($reference->date_of_birth != NULL): ?>
                                    <?php echo e(date("d F Y", strtotime($reference->date_of_birth))); ?>
                            ...
                            <tr>
                                ...
                                <td><?php echo e(date("D d F Y - h:ia", strtotime($reference->created_at))); ?></td>
                            </tr>
                            <tr>
                                <td><?php echo e(__('Last Updated')); ?></td>
                                <td><?php echo e(date("D d F Y - h:ia", strtotime($reference->updated_at))); ?></td>
                            </tr>
                        </tbody>
                    </table>
                </div>
                <div class="btn-group btn-group-justified">
                    <?php if($reference->activation_status == 1): ?>
                    <div class="btn-group">
                        <a href="<?php echo e(url('/people/references/deactive/' . $reference->id)); ?>"
                    ...
                    <?php else: ?>
                    <div class="btn-group">
                        <a href="<?php echo e(url('/people/references/active/' . $reference->id)); ?>"
                    ...
                    <div class="btn-group">
                        <a href="<?php echo e(url('/people/references/download-pdf/' . $reference->id)); ?>"
                    ...
                    <div class="btn-group">
                        <a href="<?php echo e(url('/people/references/edit/' . $reference->id)); ?>"
                    ...
                    <div class="btn-group">
                        <a href="<?php echo e(url('/people/references/delete/' . $reference->id)); ?>"
...
<?php echo $__env->make('administrator.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/projects/payroll/resources/views/administrator/people/reference/show_reference.blade.php ENDPATH**/ ?>