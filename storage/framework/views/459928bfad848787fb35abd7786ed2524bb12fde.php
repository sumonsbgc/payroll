    ...
    <section class="content">
        ...
        <div class="box bt-none">
            ...
            <div class="box-body">
                ...
                <div class="col-md-6">
                    <a href="<?php echo e(url('/setting/leave_categories/create')); ?>" class="btn btn-primary btn-flat"><i
                            class="fa fa-plus"></i> <?php echo e(__('Add leave category')); ?></a>
                </div>
                <div class="col-md-6">
                    ...
                    <table class="table table-bordered table-striped">
                        ...
                        <tbody id="myTable">
                            ...
                            <tr>
                                ...
                                <td class="text-center"><?php echo e(date("d F Y", strtotime($leave_category['created_at']))); ?>
                                ...
                                <td class="text-center">
                                    <a href="<?php echo e(url('/setting/leave_categories/edit/' . $leave_category['id'])); ?>"><i
...
<?php echo $__env->make('administrator.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/projects/payroll/resources/views/administrator/setting/leave_category/manage_leave_categories.blade.php ENDPATH**/ ?>