    ...
    <section class="content">
        ...
        <div class="box box-default bt-none">
            <div class="box-header with-border">
                <h3 class="box-title"><?php echo e(__('Edit department')); ?></h3>
            ...
            <!-- /.box-header -->
            <form action="<?php echo e(url('/setting/departments/update/'. $department['id'])); ?>" method="post"
                name="department_edit_form">
                ...
                <div class="box-body">
                    <div class="row">
                        ...
                        <!-- /.col -->
                        <div class="col-md-12">
                            <label for="department_description"><?php echo e(__('Department Description')); ?> <span
                                    class="text-danger">*</span></label>
                            <div
                                class="form-group<?php echo e($errors->has('department_description') ? ' has-error' : ''); ?> has-feedback">
                                <textarea class="textarea text-description" name="department_description"
                                    id="department_description"
                                    placeholder="<?php echo e(__('Enter client description..')); ?>"><?php echo e($department['department_description']); ?></textarea>
                                <?php if($errors->has('department')): ?>
                                <span class="help-block">
                ...
                <div class="box-footer">
                    <a href="<?php echo e(url('/setting/departments')); ?>" class="btn btn-danger btn-flat"><i
                    ...
                    <button type="submit" class="btn btn-primary btn-flat"><i class="icon fa fa-edit"></i>
                        <?php echo e(__('Update department')); ?></button>
                </div>
            </form>
        </div>
        <!-- /.box -->
...
<script type="text/javascript">
    document.forms['department_edit_form'].elements['publication_status'].value = "<?php echo e($department['publication_status']); ?>";
</script>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('administrator.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/projects/payroll/resources/views/administrator/setting/department/edit_department.blade.php ENDPATH**/ ?>