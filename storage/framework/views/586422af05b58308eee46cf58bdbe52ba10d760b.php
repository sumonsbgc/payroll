...
<div class="content-wrapper">
    ...
    <section class="content">
        ...
        <div class="box bt-none">
            ...
            <div class="box-body">
                <div class="col-md-6">
                    <a href="<?php echo e(url('/hrm/loans/create')); ?>" class="btn btn-primary btn-flat"><i
                            class="fa fa-plus"></i><?php echo e(__(' Add loan')); ?></a>
                </div>
                        ...
                        <tbody id="myTable">
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <a href="<?php echo e(url('/hrm/loans/edit/' . $loan['id'])); ?>"><i
...
<?php echo $__env->make('administrator.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/projects/payroll/resources/views/administrator/hrm/loan/manage_loans.blade.php ENDPATH**/ ?>