...
<div class="content-wrapper">
	...
	<section class="content-header">
		...
		<ol class="breadcrumb">
			...
			<li><a href="<?php echo e(url('/setting/holidays')); ?>"><?php echo e(__('Holiays')); ?></a></li>
	...
	<section class="content">
		...
		<div class="box box-default bt-none">
			<div class="box-header with-border">
				<h3 class="box-title"><?php echo e(__('Edit Holidays')); ?></h3>
			...
			<!-- /.box-header -->
			<form action="<?php echo e(url('/setting/holidays/update/' . $holidays['id'])); ?>" method="post"
				name="holidays_edit_form">
					...
					<div class="row">
						...
						<div class="col-md-6">
							...
							<div class="form-group<?php echo e($errors->has('holiday_name') ? ' has-error' : ''); ?> has-feedback">
								<input type="text" name="holiday_name" value="<?php echo e($holidays['holiday_name']); ?>"
									id="holiday_name" class="form-control">
							...
							<label for="date"><?php echo e(__('Date')); ?> <span class="text-danger">*</span></label>
							<div class="form-group<?php echo e($errors->has('date') ? ' has-error' : ''); ?> has-feedback">
								<input type="text" name="date" id="datepicker" class="form-control"
									value="<?php echo e($holidays['date']); ?>">
						...
						<div class="col-md-12">
							...
							<div class="form-group<?php echo e($errors->has('description') ? ' has-error' : ''); ?> has-feedback">
								<textarea class="textarea text-description" name="description"
									id="description"><?php echo e($holidays['description']); ?></textarea>
				...
				<div class="box-footer">
					<a href="<?php echo e(url('setting/holidays')); ?>" class="btn btn-danger btn-flat"><i
					...
					<button type="submit" class="btn btn-primary btn-flat"><i class="icon fa fa-plus"></i>
						<?php echo e(__('Update Holiday List')); ?></button>
				</div>
			</form>
		</div>
		<!-- /.box -->
...
<script type="text/javascript">
	document.forms['holidays_edit_form'].elements['publication_status'].value = "<?php echo e($holidays['publication_status']); ?>";
</script>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('administrator.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/projects/payroll/resources/views/administrator/setting/holiday/edit-holidays.blade.php ENDPATH**/ ?>