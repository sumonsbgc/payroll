    ...
    <section class="content">
        ...
        <div class="box box-default bt-none">
            <div class="box-header with-border">
                <h3 class="box-title"><?php echo e(__('Edit designation')); ?></h3>
            ...
            <!-- /.box-header -->
            <form action="<?php echo e(url('/setting/designations/update/'. $designation['id'])); ?>" method="post"
                name="designation_edit_form">
                        ...
                        <div class="col-md-12">
                            ...
                            <div
                                ...
                                <textarea class="textarea text-description" name="designation_description"
                                    id="designation_description"><?php echo e($designation['designation_description']); ?></textarea>
                                <?php if($errors->has('designation')): ?>
                                <span class="help-block">
                ...
                <div class="box-footer">
                    ...
                    <button type="submit" class="btn btn-primary btn-flat"><i class="icon fa fa-edit"></i>
                        <?php echo e(__('Update designation')); ?></button>
                </div>
            </form>
        </div>
        <!-- /.box -->
...
<script type="text/javascript">
    document.forms['designation_edit_form'].elements['publication_status'].value = "<?php echo e($designation['publication_status']); ?>";
    document.forms['designation_edit_form'].elements['department_id'].value = "<?php echo e($designation['department_id']); ?>";
</script>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('administrator.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/projects/payroll/resources/views/administrator/setting/designation/edit_designation.blade.php ENDPATH**/ ?>