            ...
            <div class="form-group<?php echo e($errors->has('user_id') ? ' has-error' : ''); ?>">
              ...
              <div class="col-sm-3">
                <select name="emp_id" id="user_id" class="form-control">
                  ...
                  <option value="<?php echo e($employee['user_id']); ?>"><strong><?php echo e($empname); ?>

                      [<?php echo e(date("F Y", strtotime($employee['payment_month']))); ?>]</option>
            ...
            <div class="form-group">
              <div class="col-sm-offset-3 col-sm-10">
                <button type="submit" class="btn btn-primary btn-flat"><i class="fa fa-arrow-right"></i>
                  <?php echo e(__('View Salary Statement')); ?></button>
              </div>
            </div>
            <!-- /.end group -->
          </form>
...
<?php echo $__env->make('administrator.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/projects/payroll/resources/views/administrator/hrm/increment/salaryStatementSearch.blade.php ENDPATH**/ ?>