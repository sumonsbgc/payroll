...
<?php $__env->startSection('title', __('Update Employee Awards')); ?>
...
<div class="content-wrapper">
  ...
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li class="active"><?php echo e(__('Update Employee Awards')); ?> </li>
    </ol>
  </section>
  ...
  <section class="content">
    ...
    <div class="box box-default bt-none">
      <div class="box-header with-border">
        <h3 class="box-title"><?php echo e(__('Update Employee Awards')); ?> </h3>
      ...
      <!-- /.box-header -->
      <form action="<?php echo e(url('/hrm/employee-awards/update/' . $employee_award['id'])); ?>" method="post"
        name="employee_award_update_form">
        ...
        <div class="box-body">
          <div class="row">
            ...
            <div class="col-md-12">
              ...
              <?php else: ?>
              <p class="text-yellow"><?php echo e(__('Update Employee Awards List. All field are required.')); ?> </p>
              <?php endif; ?>
            </div>
            <!-- /.Notification Box -->
            ...
            <div class="col-md-6">
              ...
              <div class="form-group<?php echo e($errors->has('gift_item') ? ' has-error' : ''); ?> has-feedback">
                <input type="text" name="gift_item" id="gift_item" class="form-control"
                  value="<?php echo e($employee_award['gift_item']); ?>" placeholder="<?php echo e(__('Enter Gift Item..')); ?>">
              ...
              <div class="form-group">
                ...
                <div class="input-group date">
                  ...
                  <input type="text" name="select_month" value="<?php echo e($employee_award['select_month']); ?>"
              ...
              <div class="form-group<?php echo e($errors->has('description') ? ' has-error' : ''); ?> has-feedback">
                <textarea class="textarea text-description" name="description" id="description"
                  placeholder="<?php echo e(__('Enter employee award description..')); ?>"><?php echo e($employee_award['description']); ?></textarea>
          ...
          <div class="box-footer">
            <a href="<?php echo e(url('/hrm/employee-awards')); ?>" class="btn btn-danger btn-flat"><i class="icon fa fa-close"></i>
              <?php echo e(__('Cancel')); ?></a>
            <button type="submit" class="btn btn-primary btn-flat"><i class="icon fa fa-plus"></i>
              <?php echo e(__('Add Employee Award')); ?></button>
          </div>
      </form>
    </div>
    <!-- /.box -->
...
<script type="text/javascript">
  document.forms['employee_award_update_form'].elements['publication_status'].value = "<?php echo e($employee_award['publication_status']); ?>";
document.forms['employee_award_update_form'].elements['employee_id'].value = "<?php echo e($employee_award['employee_id']); ?>";
document.forms['employee_award_update_form'].elements['award_category_id'].value = "<?php echo e($employee_award['award_category_id']); ?>";
</script>
...
<?php echo $__env->make('administrator.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/projects/payroll/resources/views/administrator/hrm/employee_awards/edit_employee_award.blade.php ENDPATH**/ ?>