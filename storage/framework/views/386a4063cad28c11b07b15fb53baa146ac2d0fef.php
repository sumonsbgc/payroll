    ...
    <section class="content">
        ...
        <div class="box box-default bt-none">
            <div class="box-header with-border">
                <h3 class="box-title"><?php echo e(__('Edit personal event')); ?></h3>
            ...
            <!-- /.box-header -->
            <form action="<?php echo e(url('/setting/personal-events/update/'. $personal_event['id'])); ?>" method="post"
                name="personal_event_edit_form">
                        ...
                        <div class="col-md-6">
                            ...
                            <div
                                ...
                                <input type="text" name="personal_event" id="personal_event" class="form-control"
                                    value="<?php echo e($personal_event['personal_event']); ?>">
                            ...
                            <div class="form-group<?php echo e($errors->has('start_date') ? ' has-error' : ''); ?> has-feedback">
                                <input type="text" name="start_date" id="datepicker" class="form-control"
                                    value="<?php echo e($personal_event['start_date']); ?>">
                            ...
                            <div class="form-group<?php echo e($errors->has('end_date') ? ' has-error' : ''); ?> has-feedback">
                                <input type="text" name="end_date" id="datepicker2" class="form-control"
                                    value="<?php echo e($personal_event['end_date']); ?>">
                        ...
                        <div class="col-md-12">
                            ...
                            <div
                                ...
                                <textarea class="textarea text-description" name="personal_event_description"
                                    id="personal_event_description"><?php echo e($personal_event['personal_event_description']); ?></textarea>
                                <?php if($errors->has('personal_event')): ?>
                                <span class="help-block">
                ...
                <div class="box-footer">
                    ...
                    <button type="submit" class="btn btn-primary btn-flat"><i class="icon fa fa-edit"></i>
                        <?php echo e(__('Update personal event')); ?></button>
                </div>
            </form>
        </div>
        <!-- /.box -->
...
<script type="text/javascript">
    document.forms['personal_event_edit_form'].elements['publication_status'].value = "<?php echo e($personal_event['publication_status']); ?>";
</script>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('administrator.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/projects/payroll/resources/views/administrator/setting/personal_event/edit_personal_event.blade.php ENDPATH**/ ?>