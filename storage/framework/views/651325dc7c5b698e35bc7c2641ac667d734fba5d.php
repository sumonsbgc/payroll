            ...
            <div class="form-group<?php echo e($errors->has('salary_month') ? ' has-error' : ''); ?>">
              ...
              <div class="col-sm-6">
                <div class="input-group date">
                  ...
                  <input type="text" name="date" id="monthpicker" class="form-control pull-right"
                    value="<?php echo e(old('salary_month')); ?>" id="datepicker">
            ...
            <div class="form-group">
              <div class="col-sm-offset-3 col-sm-10">
                <button type="submit" class="btn btn-primary btn-flat"><i
                    class="fa fa-arrow-right"></i><?php echo e(__('Add Increment')); ?> </button>
              </div>
            </div>
            <!-- /.end group -->
          </form>
...
<?php echo $__env->make('administrator.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/projects/payroll/resources/views/administrator/hrm/increment/newIncrementSearch.blade.php ENDPATH**/ ?>