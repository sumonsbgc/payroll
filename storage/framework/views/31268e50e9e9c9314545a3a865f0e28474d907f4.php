...
<div class="content-wrapper">
    ...
    <section class="content">
        ...
        <div class="box bt-none">
            ...
            <div class="box-body">
                <div class="col-md-6"> <a href="<?php echo e(url('/setting/client-types/create')); ?>"
                        class="btn btn-primary btn-flat"><i class="fa fa-plus"></i> <?php echo e(__('Add client type')); ?></a>
                </div>
                    ...
                    <table class="table table-bordered table-striped">
                        ...
                        <tbody id="myTable">
                            ...
                            <tr>
                                <td><?php echo e($sl++); ?></td>
                                <td><a
                                        href="<?php echo e(url('/setting/client-types/details/' . $client_type['id'])); ?>"><?php echo e($client_type['client_type']); ?></a>
                                </td>
                                ...
                                <td class="text-center">
                                    <a href="<?php echo e(url('/setting/client-types/edit/' . $client_type['id'])); ?>"><i
...
<?php echo $__env->make('administrator.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/projects/payroll/resources/views/administrator/setting/client_type/manage_client_types.blade.php ENDPATH**/ ?>