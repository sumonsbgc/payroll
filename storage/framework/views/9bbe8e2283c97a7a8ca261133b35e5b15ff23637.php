          ...
          <div class="row">
            ...
            <div class="col-md-6">
              ...
              <div class="form-group">
                <input type="text" name="exp_name" class="form-control" value="<?php echo e($expcat->exp_name); ?>">
              </div>
...
<?php echo $__env->make('administrator.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/projects/payroll/resources/views/administrator/hrm/expence/expensePurposeEdit.blade.php ENDPATH**/ ?>