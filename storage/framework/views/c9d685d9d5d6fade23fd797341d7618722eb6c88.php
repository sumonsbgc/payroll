    ...
    <div class="box box-default bt-none">
      ...
      <form action="<?php echo e(url('/hrm/leave_application/store')); ?>" method="post" name="add_form_leave_application">
          ...
          <div class="row">
            ...
            <div class="col-md-6">
              ...
              <div class="form-group<?php echo e($errors->has('last_leave_period') ? ' has-error' : ''); ?> has-feedback">
                <input type="text" name="last_leave_period" id="last_leave_period" class="form-control"
                  value="<?php echo e(old('last_leave_period')); ?>" placeholder="<?php echo e(__('Enter Period of Last Leave..')); ?>">
              ...
              <div class="form-group<?php echo e($errors->has('leave_address') ? ' has-error' : ''); ?> has-feedback">
                <textarea class="textarea text-description" name="leave_address"
                  placeholder="<?php echo e(__('Enter leave_address..')); ?>"><?php echo e(old('leave_address')); ?></textarea>
              ...
              <label for="during_leave"><?php echo e(__('Performing person during leave')); ?> <span
                  class="text-danger"></span></label>
              <div class="form-group<?php echo e($errors->has('during_leave') ? ' has-error' : ''); ?> has-feedback">
                <input type="text" name="during_leave" id="during_leave" class="form-control"
                  value="<?php echo e(old('during_leave')); ?>" placeholder="<?php echo e(__('Enter Performing person during leave..')); ?>">
            ...
            <div class="col-md-12">
              ...
              <div class="form-group<?php echo e($errors->has('reason') ? ' has-error' : ''); ?> has-feedback">
                <textarea class="textarea text-description" name="reason"
                  placeholder="<?php echo e(__('Enter reason Details..')); ?>"><?php echo e(old('reason')); ?></textarea>
        ...
        <div class="box-footer">
          <a href="<?php echo e(url('/hrm/leave_application')); ?>" class="btn btn-danger btn-flat"><i class="icon fa fa-close"></i>
            <?php echo e(__('Cancel')); ?></a>
          <button type="submit" class="btn btn-primary btn-flat"><i class="icon fa fa-plus"></i>
            <?php echo e(__('Add leave application')); ?></button>
        </div>
      </form>
    </div>
    <!-- /.box -->
...
<?php echo $__env->make('administrator.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/projects/payroll/resources/views/administrator/hrm/leave_application/add_leave_application.blade.php ENDPATH**/ ?>