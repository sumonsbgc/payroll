...
Route::get('monthly_report', 'Custom\PaySlipController@getMonthlyAttendence')->name('montylyreport');
Route::get('setatt', 'MachineAttController@setAttendence');
...
Route::get('logs', 'MachineAttController@getLog');
...
Route::group(['middleware' => 'auth'], function () {
    ...
    Route::get('/people/employees/print', 'EmplController@print')->name("all_empl_print");
    ...
    include_once('payroll/payroll.php');
    ...
    Route::get('/setting/options', 'OptionController@index')->name('setting.option.index');
    Route::post('/setting/options', 'OptionController@store')->name('setting.option.store');
